...
benchmarked ten harnesses on hostile-file handling — and whose Athaniel column
...
Every task runs the full Athaniel agent (file + terminal + search toolsets)
...
Rules of engagement (from athanielbench discipline):
