...
The A/B battery behind PR [#81958](https://github.com/embreythecreator/athaniel-brain/pull/81958)
...
- **Arms differ only by tree + config.** `base` runs the built-in twelve
  ...
  digest's value). Each cell gets a throwaway `ATHANIEL_HOME`; web-fetch
