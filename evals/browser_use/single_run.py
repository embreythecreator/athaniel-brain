...
The run gets a throwaway ATHANIEL_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE ATHANIEL_HOME is redirected to the
