...
required — uses aiohttp which is already a Athaniel dependency.
...
def interactive_setup() -> None:
    ...
    ``athaniel_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Athaniel delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # athaniel_cli/setup.py::_setup_mattermost function.
