"""
A2A (Agent-to-Agent) plugin for Athaniel Brain.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Athaniel as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`athaniel gateway setup` flow for A2A."""
    ...
    print_info("Expose Athaniel as an A2A-discoverable agent and call other A2A agents.")
