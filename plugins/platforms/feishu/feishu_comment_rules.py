...
Config: ~/.athaniel/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.athaniel/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_athaniel_home()`` helper (ATHANIEL_HOME-aware and
...
RULES_FILE = get_athaniel_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_athaniel_home() / "feishu_comment_pairing.json"
