...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Athaniel gateway adapter.

    Each inbound phone number gets its own Athaniel session (multi-tenant).
...
# static dict in athaniel_cli/gateway.py, and the _send_sms dispatch in
