...
``_check_spotify_available()`` — when the user has not run ``athaniel auth
spotify``, the tools remain registered (so they appear in ``athaniel
...
The Spotify auth flow (``athaniel auth spotify``), CLI plumbing, and docs
