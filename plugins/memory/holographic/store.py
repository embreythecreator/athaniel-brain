...
Single-user Athaniel memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_athaniel_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted ATHANIEL_HOME (same issue as
        # state.db / kanban.db — see athaniel_state._WAL_INCOMPAT_MARKERS).
