...
Configuration
-------------
Secret (lives in $ATHANIEL_HOME/.env or the environment):
...
Behavioral settings (live in $ATHANIEL_HOME/mem0.json, set via `athaniel memory
setup`):
  ...
  agent_id           — Agent identifier (default: athaniel)
...
_DEFAULT_USER_ID = "athaniel-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $ATHANIEL_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "athaniel"),
        "oss": {},
    }
    ...
    config_path = get_athaniel_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, athaniel_home):
        """Write config to $ATHANIEL_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, athaniel_home: str, config: dict) -> None:
        ...
        post_setup(athaniel_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ATHANIEL_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "athaniel")
