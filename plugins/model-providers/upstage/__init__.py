...
# When the user hasn't picked a reasoning effort, Athaniel passes
...
# ON at this effort — matching the "medium (default)" that Athaniel' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Athaniel' effort vocabulary onto Solar's accepted set via the
