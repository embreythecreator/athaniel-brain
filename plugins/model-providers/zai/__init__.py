...
request omits ``thinking``.  Athaniel' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Athaniel reasoning
...
(per Z.AI / BigModel docs).  Athaniel' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Athaniel reasoning effort onto GLM's native vocabulary.
