...
two endpoints so a fresh Athaniel install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``athaniel tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `athaniel tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `athaniel tools` for reliable service."
            ),
        }
...
_KEENABLE_TITLE = "athaniel-brain"
