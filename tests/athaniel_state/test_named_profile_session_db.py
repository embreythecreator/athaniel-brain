...
#88532 made SessionStore follow ATHANIEL_HOME; this covers the TUI/agent
...
def homes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(athaniel_state, "DEFAULT_DB_PATH", athaniel_state._IMPORT_DEFAULT_DB_PATH)
    return root, profile
...
def test_open_profile_session_db_does_not_fallback_on_open_failure(homes, monkeypatch):
    ...
    monkeypatch.setattr("athaniel_state.SessionDB", boom_db)
