...
_CA_ENV_VARS = ("ATHANIEL_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "HTTPS_PROXY")
...
def test_build_keepalive_http_client_uses_athaniel_ca_bundle(clean_tls_env, monkeypatch):
    monkeypatch.setenv("ATHANIEL_CA_BUNDLE", certifi.where())
