...
def _make_agent():
    athaniel_home = Path(tempfile.mkdtemp(prefix="athaniel-test-home-"))
    (athaniel_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._athaniel_home", athaniel_home),
