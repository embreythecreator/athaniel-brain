...
from athaniel_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/athaniel_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("athaniel_cli.lifecycle.invoke_hook")
@patch("athaniel_cli.lifecycle.finalize_session")
