...
Root cause: ``AthanielCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a AthanielCLI with prompt_toolkit stubbed (same pattern as
