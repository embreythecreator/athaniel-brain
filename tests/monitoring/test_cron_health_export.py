...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("athaniel.gateway.up"), _M("athaniel.gateway.active_agents"),
        _M("athaniel.gateway.busy"), _M("athaniel.gateway.drainable"),
        _M("athaniel.gateway.restart_requested"),
        _M("athaniel.platform.up"), _M("athaniel.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("athaniel.cron.scheduler.heartbeat_age_seconds"),
        _M("athaniel.cron.scheduler.last_success_age_seconds"),
        _M("athaniel.cron.scheduler.catch_up_occurrences"),
        _M("athaniel.cron.jobs.enabled"), _M("athaniel.cron.jobs.running"),
        _M("athaniel.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "Athaniel Brain-owned Relay transport health" in text
