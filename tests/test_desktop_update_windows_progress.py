...
window keeps moving through the long silent stretches (`athaniel update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["ATHANIEL_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('Athaniel will open once done.' ==
