...
Real config files in a temp ATHANIEL_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated ATHANIEL_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "ATHANIEL_LOCAL_STT_LANGUAGE",
    ):
