...
* ``athaniel_constants.get_athaniel_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_athaniel_dir so cache writes land under tmp_path."""
    ...
    with patch("athaniel_constants.get_athaniel_dir", _fake_get):
        yield cache_dir
