...
def worker_env(monkeypatch, tmp_path):
    """Isolated ATHANIEL_HOME with a running task; returns the task id."""
...
# ---------------------------------------------------------------------------
# Negative test — force=True bypasses ATHANIEL_REDACT_SECRETS=false
# ---------------------------------------------------------------------------

def test_scrub_respects_force_flag_regardless_of_config(worker_env, monkeypatch):
    """force=True must fire even when ATHANIEL_REDACT_SECRETS=false is set."""
