...
def ledger_env(tmp_path, monkeypatch):
    """Isolated ATHANIEL_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_athaniel_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_athaniel_home", lambda: home)
...
def test_rollback_refuses_paths_outside_athaniel_home(ledger_env):
    """A hand-edited ledger entry pointing outside ATHANIEL_HOME must not
