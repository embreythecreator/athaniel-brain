...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/athaniel config files without modify intent.
        ...
        assert _scan_memory_content("Read .athaniel/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .athaniel/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .athaniel/config.yaml to change settings", "athaniel_config_mod")
        _blocked("update .athaniel/SOUL.md with new personality", "athaniel_config_mod")
