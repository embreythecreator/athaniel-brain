...
def _restore_tool_modules():
    original_athaniel_home = os.environ.get("ATHANIEL_HOME")
    original_modules = {
        name: module
        for name, module in sys.modules.items()
        if name == "tools"
        or name.startswith("tools.")
        or name == "athaniel_cli"
        or name.startswith("athaniel_cli.")
        or name == "modal"
    ...
    try:
        ...
        if original_athaniel_home is None:
            os.environ.pop("ATHANIEL_HOME", None)
        else:
            os.environ["ATHANIEL_HOME"] = original_athaniel_home
        _reset_modules(("tools", "athaniel_cli", "modal"))
...
def _install_modal_test_modules(
    ...
    *,
    ...
    athaniel_cli = types.ModuleType("athaniel_cli")
    athaniel_cli.__path__ = []  # type: ignore[attr-defined]
    sys.modules["athaniel_cli"] = athaniel_cli
    athaniel_home = tmp_path / "athaniel-home"
    os.environ["ATHANIEL_HOME"] = str(athaniel_home)
    sys.modules["athaniel_cli.config"] = types.SimpleNamespace(
        get_athaniel_home=lambda: athaniel_home,
    )
    ...
    async def _lookup_aio(_name: str, create_if_missing: bool = False):
        return types.SimpleNamespace(name="athaniel-brain", create_if_missing=create_if_missing)
    ...
    return {
        "snapshot_store": athaniel_home / "modal_snapshots.json",
