...
def worker_home(tmp_path, monkeypatch):
    ...
    for var in ("ATHANIEL_KANBAN_DB", "ATHANIEL_KANBAN_WORKSPACES_ROOT", "ATHANIEL_KANBAN_HOME", "ATHANIEL_KANBAN_BOARD"):
...
def test_seed_then_inject_new_comment(worker_home, monkeypatch):
    ...
    monkeypatch.setenv("ATHANIEL_PROFILE", "worker-bot")
    agent = FakeAgent()
