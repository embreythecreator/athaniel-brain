"""The `athaniel-brain` skill is what a running Athaniel knows about itself.

`website/` is never packaged, so an installed Athaniel has no local copy of the
user guide; skills ARE synced into `$ATHANIEL_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Athaniel can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "athaniel-brain"
