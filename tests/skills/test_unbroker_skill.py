...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and athaniel-brain
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # athaniel-brain (tests/skills/)
]
