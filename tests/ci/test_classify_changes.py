...
CASES = {
    ...
    "product python → nix": (["athaniel_cli/config.py"], _lanes(python=True, scan=True)),
...
def test_pull_request_changed_files_skips_non_pr_events(monkeypatch):
    ...
    monkeypatch.setenv("REPO", "embreythecreator/athaniel-brain")
