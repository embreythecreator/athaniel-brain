...
The unit tests in tests/athaniel_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned athaniel-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/athaniel")
from athaniel_cli.service_manager import S6ServiceManager
