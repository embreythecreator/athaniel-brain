...
class TestReasoningCommand:
    ...
    def test_resolve_session_reasoning_prefers_session_override(self, tmp_path, monkeypatch):
        athaniel_home = tmp_path / "athaniel"
        athaniel_home.mkdir()
        (athaniel_home / "config.yaml").write_text("agent:\n  reasoning_effort: low\n", encoding="utf-8")
    ...
    def test_run_agent_includes_enabled_mcp_servers_in_gateway_toolsets(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(gateway_run, "_athaniel_home", athaniel_home)
        monkeypatch.setattr(gateway_run, "_env_path", athaniel_home / ".env")
...
class TestLoadShowReasoningCoercion:
    ...
    def _load_with_config(self, tmp_path, monkeypatch, yaml_body: str) -> bool:
        athaniel_home = tmp_path / "athaniel"
        athaniel_home.mkdir()
        (athaniel_home / "config.yaml").write_text(yaml_body, encoding="utf-8")
        monkeypatch.setattr(gateway_run, "_athaniel_home", athaniel_home)
