"""Tests for _setup_feishu() in athaniel_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("athaniel_cli.config.save_env_value", side_effect=mock_save), \
         patch("athaniel_cli.config.get_env_value", side_effect=mock_get), \
         patch("athaniel_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("athaniel_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("athaniel_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("athaniel_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("athaniel_cli.cli_output.print_header"), \
         patch("athaniel_cli.cli_output.print_info"), \
         patch("athaniel_cli.cli_output.print_success"), \
         patch("athaniel_cli.cli_output.print_warning"), \
         patch("athaniel_cli.cli_output.print_error"), \
