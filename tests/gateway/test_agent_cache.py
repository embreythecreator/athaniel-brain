...
class TestAgentConfigSignature:
    ...
    def test_model_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["athaniel-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-opus-4.6", runtime, ["athaniel-telegram"], "")
        assert sig1 != sig2
    ...
    def test_same_token_prefix_different_full_token_changes_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt1, ["athaniel-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt2, ["athaniel-telegram"], "")
        assert sig1 != sig2
    ...
    def test_provider_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt1, ["athaniel-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt2, ["athaniel-telegram"], "")
        assert sig1 != sig2
    ...
    def test_default_gateway_runtime_forwards_filtered_capabilities(self, monkeypatch):
        ...
        from athaniel_cli import runtime_provider
...
class TestExtractCacheBustingConfig:
    ...
    def test_reads_compression_subkeys(self):
        ...
        assert out["compression.codex_app_server_auto"] == "athaniel"
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["athaniel-telegram"], "")
...
class TestAgentConfigSignatureUserId:
    ...
    def test_signature_omits_user_id_when_absent(self):
        ...
        sig_implicit = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["athaniel-telegram"], "",
        )
...
class TestAgentCacheMessageCountRebaseline:
    ...
    def _runner_with_db(self, db):
        from athaniel_state import AsyncSessionDB
