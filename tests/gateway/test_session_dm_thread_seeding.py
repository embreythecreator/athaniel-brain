...
def store(tmp_path, monkeypatch):
    ...
    ~/.athaniel/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at athaniel_state import time, before pytest's ATHANIEL_HOME monkeypatch
    fires — the autouse fixture's ATHANIEL_HOME override doesn't help here.)
    """
