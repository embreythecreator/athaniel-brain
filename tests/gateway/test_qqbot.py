...
class TestDefaultInteractionDispatch:
    ...
    async def test_update_prompt_click_writes_response_file(self, tmp_path, monkeypatch):
        """update_prompt:y click writes 'y' to ~/.athaniel/.update_response."""
        adapter = self._make_adapter()
        athaniel_home = tmp_path / "athaniel_home"
        athaniel_home.mkdir()
        monkeypatch.setattr(
            "athaniel_constants.get_athaniel_home",
            lambda: athaniel_home,
        )
        ...
        response = athaniel_home / ".update_response"
