...
Run from the PR worktree:
    ...
    cd ~/.athaniel/athaniel-brain/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.athaniel/athaniel-brain``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.athaniel/athaniel-brain
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a athaniel-brain checkout"
)
...
# Isolated ATHANIEL_HOME for the config write.
