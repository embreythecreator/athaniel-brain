...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure ATHANIEL_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", athaniel_home=str(tmp_path / ".athaniel"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("ATHANIEL_HOME", str(athaniel_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", athaniel_home=str(athaniel_home))
        return p
