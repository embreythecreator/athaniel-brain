"""Regression test: athaniel update must not load cryptography eagerly."""
...
assert 'athaniel_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running athaniel update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so athaniel_cli is importable,
...
import athaniel_cli.main
from athaniel_cli.update_cmd import _cmd_update_check
