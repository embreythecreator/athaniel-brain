...
Keeps the ACP server tests offline: ``AthanielACPAgent._build_model_state``
calls ``athaniel_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import athaniel_cli.inventory as inventory
