"""Tests for the athaniel-tools-as-MCP server module surface.
...
from agent.transports.athaniel_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import athaniel_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.athaniel_tools_mcp_server as m
