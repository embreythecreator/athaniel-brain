...
Damien's incident (Discord, 2026-05-28): a long Athaniel session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``athaniel_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "athaniel_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "athaniel_state"
