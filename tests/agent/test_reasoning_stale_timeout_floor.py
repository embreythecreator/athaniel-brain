...
thinking phase.  Athaniel's default cloud-stream stale detector
(``ATHANIEL_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ATHANIEL_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
