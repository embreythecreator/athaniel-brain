...
manipulation. Athaniel keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ATHANIEL_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_athaniel_home /
    get_default_athaniel_root) instead of monkeypatching private helpers —
    ...
    ATHANIEL_HOME=<root>/profiles/<name> makes get_default_athaniel_root()
