...
The official Codex endpoint must receive Athaniel' own harness identity, rather
...
These tests pin:
- the required Athaniel originator
- the versioned Athaniel User-Agent
...
class TestCodexCloudflareHeaders:
    ...
    def test_user_agent_advertises_athaniel_version(self):
...
class TestPrimaryClientWiring:
    ...
    def test_apply_client_headers_on_base_url_change(self):
        ...
        with patch("run_agent.OpenAI") as mock_openai:
            ...
            assert headers.get("originator") == "athaniel-brain"
            assert headers.get("ChatGPT-Account-ID") == "acct-rotation"
            assert headers.get("User-Agent") == f"AthanielAgent/{__version__}"
