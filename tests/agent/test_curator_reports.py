...
Reports live under ``~/.athaniel/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated ATHANIEL_HOME with a skills/ dir + reset curator module state."""
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "ATHANIEL_DIR", home)
