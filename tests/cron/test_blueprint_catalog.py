...
the shared /blueprint command handler (athaniel_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated ATHANIEL_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("athaniel://blueprint/morning-brief?")
