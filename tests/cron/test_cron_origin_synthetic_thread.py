...
class TestSlackSyntheticThreadCapture:
    def test_synthetic_slack_thread_not_captured(self):
        ...
        env = {
            "ATHANIEL_SESSION_PLATFORM": "slack",
            "ATHANIEL_SESSION_CHAT_ID": "D0BJTDCSR7C",
            "ATHANIEL_SESSION_THREAD_ID": "1755043010.123456",
            "ATHANIEL_SESSION_MESSAGE_ID": "1755043010.123456",
        }
    ...
    def test_genuine_slack_thread_preserved(self):
        ...
        env = {
            "ATHANIEL_SESSION_PLATFORM": "slack",
            "ATHANIEL_SESSION_CHAT_ID": "C0AGENERAL",
            "ATHANIEL_SESSION_THREAD_ID": "1755040000.000100",
            "ATHANIEL_SESSION_MESSAGE_ID": "1755043010.123456",
        }
        with _session_env(env):
            origin = _origin_from_env()
    ...
    def test_non_slack_platform_thread_untouched(self):
        ...
        env = {
            ...
            "ATHANIEL_SESSION_CHAT_ID": "-1003941067111",
            "ATHANIEL_SESSION_THREAD_ID": "2203",
            "ATHANIEL_SESSION_MESSAGE_ID": "2203",
        }
        with _session_env(env):
            origin = _origin_from_env()
        assert origin is not None
