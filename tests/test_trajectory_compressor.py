...
def test_import_loads_env_from_athaniel_home(tmp_path, monkeypatch):
    home = tmp_path / ".athaniel"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-athaniel-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-athaniel-home"
