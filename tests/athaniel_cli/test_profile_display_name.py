...
The canonical profile id ("default" for ~/.athaniel) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and ATHANIEL_HOME under tmp_path."""
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "athaniel_cli.profiles.check_alias_collision", lambda name: "skip"
        )
