...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "get_athaniel_home", lambda: athaniel_home)
    monkeypatch.setattr(uninstall, "_is_default_athaniel_home", lambda home: False)
    ...
    assert str(athaniel_home) in output
    assert project_root.exists()
    assert athaniel_home.exists()
