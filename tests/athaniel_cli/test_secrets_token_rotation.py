"""Tests for `athaniel secrets bitwarden token` / `athaniel secrets onepassword token`.
...
from athaniel_cli import onepassword_secrets_cli as op_cli
from athaniel_cli import secrets_cli as bw_cli
