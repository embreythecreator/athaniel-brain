...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`athaniel_cli.slash_exec.EXECUTORS`, and
...
from athaniel_cli.commands import COMMAND_REGISTRY, resolve_command
from athaniel_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
