"""Tests for ``athaniel approvals suggest`` (athaniel_cli/approvals_suggest.py).

Approval history in Athaniel is implied, not ledgered: the session DB
...
from athaniel_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
