"""Tests for the ``athaniel prompt-size`` diagnostic (issue #34667)."""
...
from athaniel_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(athaniel_home, memory_text="", user_text=""):
    mem_dir = athaniel_home / "memories"
...
def _seed_skill(athaniel_home, name, description):
    skill_dir = athaniel_home / "skills" / "demo" / name
