...
The main() function in athaniel_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `athaniel -c model`
...
def _build_parser():
    """Build a minimal replica of the athaniel top-level parser."""
