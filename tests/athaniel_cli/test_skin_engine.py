"""Tests for athaniel_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from athaniel_cli import skin_engine
...
class TestSkinConfig:
    def test_default_skin_has_required_fields(self):
        from athaniel_cli.skin_engine import load_skin
    ...
    def test_get_color_with_fallback(self):
        from athaniel_cli.skin_engine import load_skin
        skin = load_skin("default")
        # default is the plain-monochrome skin (ponytail pass): banner_title
        # follows the terminal's own fg via "default", not a hardcoded hex.
        assert skin.get_color("banner_title") == "default"
        assert skin.get_color("nonexistent", "#000") == "#000"

    def test_get_branding_with_fallback(self):
        from athaniel_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "Athaniel Brain"
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from athaniel_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("athaniel_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from athaniel_cli.skin_engine import set_active_skin
...
class TestCliBrandingHelpers:
    ...
    def test_active_goodbye_ares(self):
        from athaniel_cli.skin_engine import set_active_skin, get_active_goodbye

        set_active_skin("ares")
        assert get_active_goodbye() == "Farewell, warrior! ⚔"

    def test_prompt_toolkit_style_overrides_cover_tui_classes(self):
        from athaniel_cli.skin_engine import set_active_skin, get_prompt_toolkit_style_overrides
        set_active_skin("ares")
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from athaniel_cli.skin_engine import (
            set_active_skin,
            get_active_skin,
