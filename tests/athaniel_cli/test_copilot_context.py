...
class TestGetCopilotModelContext:
    ...
    @patch("athaniel_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("athaniel_cli.models._urlopen_model_catalog_request")
    ...
    @patch("athaniel_cli.models.fetch_github_model_catalog", return_value=[])
