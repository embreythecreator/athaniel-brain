"""Tests for the specifier module + `athaniel kanban specify` CLI surface.
...
from athaniel_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `athaniel kanban …` argparse surface directly."""
