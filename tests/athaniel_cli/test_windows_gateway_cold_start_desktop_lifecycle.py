...
from athaniel_cli import gateway as athaniel_gateway
from athaniel_cli import gateway_windows
from athaniel_cli import main as cli_main
from athaniel_cli import process_identity
...
def test_control_plane_argv_is_not_a_gateway():
    ...
    serve = "C:\\Athaniel\\.venv\\Scripts\\python.exe -m athaniel_cli.main serve --host 127.0.0.1"
    run = "C:\\Athaniel\\.venv\\Scripts\\python.exe -m athaniel_cli.main gateway run"
...
def test_control_plane_classifier_is_token_based_not_substring():
    ...
    py = "C:\\Athaniel\\.venv\\Scripts\\python.exe -m athaniel_cli.main"
...
def test_pause_skips_cold_start_plan_when_desktop_owns_lifecycle(monkeypatch):
    ...
    monkeypatch.setattr(athaniel_gateway, "find_gateway_pids", lambda **_k: [])
    monkeypatch.setattr(
        athaniel_gateway, "find_windows_gateway_services", lambda **_k: []
    )
