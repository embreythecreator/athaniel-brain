...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from athaniel_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ATHANIEL_OVERLAYS
        overlay = ATHANIEL_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify athaniel doctor recognizes Xiaomi env vars."""
