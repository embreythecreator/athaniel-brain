"""Tests for `athaniel chat --safe-mode` isolation."""
...
_VARS = ("ATHANIEL_SAFE_MODE", "ATHANIEL_IGNORE_USER_CONFIG", "ATHANIEL_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ATHANIEL_SAFE_MODE"] == "1"
        assert os.environ["ATHANIEL_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ATHANIEL_IGNORE_RULES"] == "1"
        return True
