"""Regression: ``athaniel update`` should take a managed checkout off autocrlf=true.
...
``athaniel update`` has to repair them.
...
from athaniel_cli.update_cmd import _normalize_managed_eol
