...
The oneshot path builds its AIAgent directly (bypassing AthanielCLI), so the
...
from athaniel_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
