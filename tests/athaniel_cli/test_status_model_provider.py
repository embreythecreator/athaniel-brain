"""Tests for athaniel_cli.status model/provider display."""

from types import SimpleNamespace

from athaniel_cli.nous_account import NousPaidServiceAccessInfo, NousPortalAccountInfo
...
def test_show_status_reports_empty_lmstudio_listing_as_reachable(monkeypatch, capsys, tmp_path):
    ...
    monkeypatch.setattr(
        "athaniel_cli.models.probe_lmstudio_models",
