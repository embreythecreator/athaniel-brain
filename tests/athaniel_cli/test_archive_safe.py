"""Tests for the shared tar.gz writer (``athaniel_cli.archive_safe.make_targz``).

``make_targz`` backs both ``athaniel profile export`` and ``athaniel kanban
...
from athaniel_cli.archive_safe import make_targz
