...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (athaniel_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_athaniel_overlays():
    """athaniel_cli.providers.get_provider("vertex") backs
