"""Tests for the shared byte formatter (athaniel_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from athaniel_cli.backup import _format_size as backup
    from athaniel_cli.checkpoints import _fmt_bytes as checkpoints
    from athaniel_cli.doctor import _human_bytes as doctor
