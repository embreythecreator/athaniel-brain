"""Tests for the interactive session browser (`athaniel sessions browse`).
...
from athaniel_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """athaniel sessions browse should be parseable."""
