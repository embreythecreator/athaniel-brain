"""Tests for `athaniel curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ATHANIEL_HOME with real agent-created skills on disk."""
    ...
    from athaniel_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import athaniel_cli.curator as curator_cli
