...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (ATHANIEL_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via ATHANIEL_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in ATHANIEL_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from athaniel_cli.providers import ATHANIEL_OVERLAYS
        assert "bedrock" in ATHANIEL_OVERLAYS
