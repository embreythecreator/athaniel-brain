"""Tests for `_can_open_graphical_browser()` in athaniel_cli.auth.

Guards the fix for the May 2026 report where `athaniel auth add xai-oauth`
...
from athaniel_cli.auth import _can_open_graphical_browser
