...
def make_athaniel_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ATHANIEL_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"athaniel-home-{journal_mode}"
