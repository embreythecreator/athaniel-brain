"""Session <-> workspace grouping key (athaniel_state.workspace_key).

The key is what `athaniel sessions list --workspace` groups/filters on. It is a
...
from athaniel_state import workspace_key
