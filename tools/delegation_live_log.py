...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.athaniel)."""
    from athaniel_constants import get_athaniel_dir

    return get_athaniel_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Athaniel subagent live transcript ===",
