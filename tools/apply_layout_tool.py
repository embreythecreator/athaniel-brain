#!/usr/bin/env python3
"""Apply a layout preset in the Athaniel desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the Athaniel desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the Athaniel desktop app when the user "
