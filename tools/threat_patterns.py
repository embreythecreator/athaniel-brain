...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    # Negative lookahead ports upstream v2026.8.31's refinement: only flag
    # concealment instructions, not ordinary UX guidance ("don't tell the
    # user X unless Y confirms").
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|ATHANIEL|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.athaniel/\.env|\~/\.athaniel/\.env', "athaniel_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.athaniel/(config\.yaml|SOUL\.md)', "athaniel_config_mod", "strict"),
...
def scan_for_threats(content: str, scope: str = "context") -> List[str]:
    ...
    # bypassing keyword checks (e.g. ``ｃａｔ ~/.athaniel/.env``).  NOTE: this
