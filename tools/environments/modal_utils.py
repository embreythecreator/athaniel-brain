"""Shared Athaniel-side execution flow for Modal transports.

This module deliberately stops at the Athaniel boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"ATHANIEL_EOF_{uuid.uuid4().hex[:8]}"
