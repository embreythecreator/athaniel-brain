#!/usr/bin/env python3
"""Point at something in the Athaniel desktop GUI and say one line about it.
...
Athaniel raises mid-conversation in answer to something the user said.
...
def tip_tool(text: str, selector: str, title: str = "", side: str = "") -> str:
    ...
    if not ok:
        return tool_error("tip is only available in the Athaniel desktop app.")
