...
Trust levels:
  - builtin:   Ships with Athaniel. Never scanned, always trusted.
...
_ATHANIEL_CONFIG_FILES = r'\.athaniel/(?:config\.yaml|SOUL\.md)'
...
SKILL_INSTALL_PATTERNS = [
    ...
    (r'\$HOME/\.athaniel/\.env|\~/\.athaniel/\.env',
     "athaniel_env_access", "critical", "exfiltration",
     "directly references Athaniel secrets file"),
    ...
    #     For Athaniel/other config files it is high (caution) — legitimate
    ...
    (_prose_modify_re(_ATHANIEL_CONFIG_FILES),
     "athaniel_config_mod", "high", "persistence",
     "modification language aimed at Athaniel configuration files (verify intent)"),
    (_shell_write_re(_ATHANIEL_CONFIG_FILES),
     "athaniel_config_mod_shell", "critical", "persistence",
     "shell write (redirect/sed -i/tee/cp/mv) targeting Athaniel configuration files"),
    (r'\.athaniel/config\.yaml|\.athaniel/SOUL\.md',
     "athaniel_config_ref", "low", "persistence",
     "references Athaniel configuration files (informational; only modification intent is scored)"),
...
# scan. `.skillignore` is the Athaniel-native name; `.clawhubignore` is honored
