#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the Athaniel desktop GUI.
...
- ``surface="app"`` — the Athaniel desktop app's own DOM (tours of Athaniel itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the Athaniel desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (Athaniel itself) "
