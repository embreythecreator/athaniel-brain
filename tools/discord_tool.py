...
Only included in the athaniel-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Athaniel Brain (https://github.com/embreythecreator/athaniel-brain)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_athaniel_home() / "cache" / "discord_capabilities.json"
