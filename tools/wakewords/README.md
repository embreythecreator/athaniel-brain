...
`hey_athaniel.onnx` / `hey_athaniel.tflite` — the on-device "Hey Athaniel" hotword
...
- **Label:** the model registers as `hey_athaniel` (matches the filename).
