#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Athaniel desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the Athaniel desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Athaniel desktop GUI (the pane open_preview opens beside this chat). Call "
