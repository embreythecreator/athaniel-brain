...
the get_anchored_view / get_messages_around primitives in athaniel_state.
...
from athaniel_state_common import _RESET_END_REASONS

# Sources that are excluded from session browsing/searching by default.
# Third-party integrations tag their sessions with ATHANIEL_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Search past Athaniel sessions (FTS5 over the local session DB), or read/"
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Athaniel profile's database "
