# nix/web.nix — Athaniel Web Dashboard (Vite/React) frontend build
{ athanielNpmLib, ... }:
athanielNpmLib.buildNpmPackage {
  dirs = [
    "web"

    # @athaniel/shared ships as a file: workspace dep of web, so its source
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../athaniel_cli/web_dist for the
