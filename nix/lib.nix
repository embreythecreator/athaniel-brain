...
let
      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ATHANIEL_BUNDLED_SKILLS /
            # ATHANIEL_OPTIONAL_SKILLS (see athaniel-brain.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ATHANIEL_BUNDLED_LOCALES
            # / ATHANIEL_OPTIONAL_MCPS, not via the wheel. Excluding them
  ...
  #
  # Usage:
  #   athanielNpmLib.buildNpmPackage {
