# nix/overlays.nix — Expose pkgs.athaniel-brain for external NixOS configs
#
...
# `pkgs.athaniel-brain`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    athaniel-brain = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
