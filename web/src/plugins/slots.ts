 ...
 * `window.__ATHANIEL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Athaniel brand in the top bar
 ...
 *  `window.__ATHANIEL_PLUGINS__.registerSlot(...)`.
 *
