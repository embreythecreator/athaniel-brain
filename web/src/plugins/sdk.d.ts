/**
 * Athaniel Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ATHANIEL_PLUGIN_SDK__`` and
 * ``window.__ATHANIEL_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ATHANIEL_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``AthanielPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@athaniel/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ATHANIEL_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ATHANIEL_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ATHANIEL_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface AthanielPluginSDK {
...
declare global {
  interface Window {
    __ATHANIEL_PLUGIN_SDK__?: AthanielPluginSDK;
    __ATHANIEL_PLUGINS__?: PluginRegistry;
  }
}
