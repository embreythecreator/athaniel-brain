 ...
 *
 * Plugins call window.__ATHANIEL_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ATHANIEL_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ATHANIEL_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ATHANIEL_PLUGIN_SDK__ = {
    ...
    // window.__ATHANIEL_SESSION_TOKEN__ directly.
    authedFetch,
