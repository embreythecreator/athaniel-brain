 ...
 *
 * Values mirror athaniel_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Athaniel default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Athaniel' default when unset). */
