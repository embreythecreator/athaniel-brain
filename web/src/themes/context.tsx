...
const STORAGE_KEY = "athaniel-dashboard-theme";
...
const FONT_STORAGE_KEY = "athaniel-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `athaniel_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "athaniel-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-athaniel-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-athaniel-theme-font", "true");
