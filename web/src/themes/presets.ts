 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `athaniel_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Athaniel Teal",
  description: "Classic dark teal — the canonical Athaniel look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Athaniel Teal (Large)",
  description: "Athaniel Teal with bigger fonts and roomier spacing",
