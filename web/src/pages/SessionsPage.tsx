...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    athaniel_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__athaniel_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Athaniel-Session-Token":
              (window as unknown as { __ATHANIEL_SESSION_TOKEN__?: string })
                .__ATHANIEL_SESSION_TOKEN__ ?? "",
          },
        });
