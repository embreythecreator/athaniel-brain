...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateAthaniel: "Athaniel frissítése",
    updatingAthaniel: "Athaniel frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Athaniel-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `athaniel plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.athaniel/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.athaniel/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.athaniel/skills/ mappából töltődnek be",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a Athaniel nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Athaniel-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Athaniel munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Athanielt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Athaniel kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Athaniel egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
