...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateAthaniel: "Оновити Athaniel",
    updatingAthaniel: "Оновлення Athaniel…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Athaniel (паритет з `athaniel plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.athaniel/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.athaniel/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.athaniel/skills/",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які Athaniel не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Колекційні значки Athaniel, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",
      scan_subtitle:
        "Сканування історії сеансів Athaniel. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте Athaniel частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно Athaniel побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "Athaniel одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
