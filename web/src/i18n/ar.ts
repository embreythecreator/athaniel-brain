...
export const ar = defineLocale({
  ...
  status: {
    ...
    updatingAthaniel: "جاري تحديث Athaniel…",
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات Athaniel الإضافية (مطابقة `athaniel plugins`).",
    ...
    removeConfirm: "إزالة هذا المكوِّن الإضافي من ~/.athaniel/plugins/؟",
    removeHint: "يمكن إزالة المكوِّنات المثبتة من المستخدم تحت ~/.athaniel/plugins فقط.",
  ...
  skills: {
    ...
    categories: "الفئات",
    filters: "الفلاتر",
    noSkills: "لم يُعثر على مهارات. يتم تحميل المهارات من ~/.athaniel/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات Athaniel",
      subtitle:
        "شارات Athaniel قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات Athaniel. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل Athaniel أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى Athaniel إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص Athaniel السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في Athaniel Brain ☤"
    },
  },
