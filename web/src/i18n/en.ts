...
export const en: Translations = {
  ...
  status: {
    ...
    updateAthanielConfirmMessage:
      "This runs athaniel update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateAthanielConfirmNow: "Update now",
    updateAthanielConfirmTitle: "Update Athaniel?",
    updatingAthaniel: "Updating Athaniel…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Athaniel plugins (`athaniel plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.athaniel/plugins/?",
    removeHint: "Only user-installed plugins under ~/.athaniel/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.athaniel/skills/",
  ...
  config: {
    configPath: "~/.athaniel/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Athaniel doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Athaniel Achievements",
      subtitle:
        "Collectible Athaniel badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Athaniel session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Athaniel more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Athaniel sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Athaniel is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Athaniel Brain ☤",
    },
  },
