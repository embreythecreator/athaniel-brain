...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateAthaniel: "Atualizar Athaniel",
    updatingAthaniel: "A atualizar Athaniel…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Athaniel (paridade com `athaniel plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.athaniel/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.athaniel/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.athaniel/skills/",
  ...
  env: {
    ...
    customHint: "Variáveis de ambiente arbitrárias armazenadas no seu .env que o Athaniel não reconhece. Use-as para injetar variáveis de ambiente para skills, servidores MCP ou suas próprias ferramentas.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do Athaniel obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Athaniel. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Athaniel",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Athaniel detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Athaniel analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
