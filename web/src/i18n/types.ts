...
export interface Translations {
  ...
  status: {
    ...
    updateAthanielConfirmMessage?: string;
    updateAthanielConfirmNow?: string;
    updateAthanielConfirmTitle?: string;
    updatingAthaniel: string;
  ...
  // ── Achievements plugin (plugins/athaniel-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
