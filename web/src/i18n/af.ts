...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateAthaniel: "Werk Athaniel op",
    updatingAthaniel: "Besig om Athaniel op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Athaniel-inproppe op (`athaniel plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.athaniel/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.athaniel/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.athaniel/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrêre omgewingsveranderlikes wat in jou .env gestoor is en wat Athaniel nie herken nie. Gebruik dit om omgewingsveranderlikes vir vaardighede, MCP-bedieners of jou eie gereedskap in te spuit.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Athaniel-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Athaniel-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Athaniel meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Athaniel 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Athaniel skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
