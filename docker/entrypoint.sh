...
# by /etc/cont-init.d/01-athaniel-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs athaniel"
...
echo "[athaniel] WARNING: docker/entrypoint.sh is a deprecated shim under " \
