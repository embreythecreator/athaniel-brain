...
def _state_dir() -> Path:
    ...
    # Default: $ATHANIEL_HOME/watcher-state/, falling back to ~/.athaniel/watcher-state/.
    athaniel_home = os.environ.get("ATHANIEL_HOME") or str(Path.home() / ".athaniel")
    return Path(athaniel_home) / "watcher-state"
