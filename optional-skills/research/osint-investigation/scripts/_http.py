...
DEFAULT_UA = (
    "athaniel-osint-investigation/0.2 "
    "(+https://github.com/embreythecreator/athaniel-brain; "
    "set ATHANIEL_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("ATHANIEL_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
