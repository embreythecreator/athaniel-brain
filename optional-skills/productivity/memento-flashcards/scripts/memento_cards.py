...
Data file: $ATHANIEL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ATHANIEL_HOME = Path(os.environ.get("ATHANIEL_HOME", Path.home() / ".athaniel"))
DATA_DIR = _ATHANIEL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
