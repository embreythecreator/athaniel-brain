"""ACP permission bridging for Athaniel dangerous-command approvals."""
...
# Maps ACP permission option ids to Athaniel approval result strings.
...
def _build_permission_options(
    *, allow_permanent: bool, allow_session: bool = True,
    ...
    """Return ACP options that match Athaniel approval semantics."""
    ...
    # Smart DENY override — the editor must not offer a scope Athaniel
    ...
    if not once_only:
        options.append(PermissionOption(
            ...
            # hint while keeping Athaniel semantics in the option id.
            kind="allow_always",
...
def _map_outcome_to_athaniel(outcome: object, *, allowed_option_ids: set[str]) -> str:
    """Map an ACP permission outcome into Athaniel approval strings."""
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_ATHANIEL.get(option_id, "deny")
...
def make_approval_callback(
    ...
    """
    Return a Athaniel-compatible approval callback that bridges to ACP.
    ...
    def _callback(
        ...
        **_: object,
        ...
        return _map_outcome_to_athaniel(
            response.outcome,
