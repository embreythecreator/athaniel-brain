...
await build({
  ...
  // Skip the prebuilt @athaniel/ink bundle and inline the source instead:
  ...
  alias: { '@athaniel/ink': resolve(root, 'packages/athaniel-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The athaniel_cli launcher
