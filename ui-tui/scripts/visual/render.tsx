 ...
 * across theme x background scenes to <tmpdir>/athaniel-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@athaniel/ink'
...
// The regenerated slate light_colors block from athaniel_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/athaniel-brain',
...
const setup = (bgHex: string) => {
  process.env.ATHANIEL_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
