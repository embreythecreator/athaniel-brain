...
import type { ScrollBoxHandle } from '@athaniel/ink'
import { evictInkCaches } from '@athaniel/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ATHANIEL_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
