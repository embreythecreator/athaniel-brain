import type { BillingBlock, UsageModelData } from '@athaniel/shared/billing'
import type { AthanielSkin } from '@athaniel/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@athaniel/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = AthanielSkin
...
// Wire shapes now live in @athaniel/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
