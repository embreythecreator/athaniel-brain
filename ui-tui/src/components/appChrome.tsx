import { Box, type ScrollBoxHandle, stringWidth, Text } from '@athaniel/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ATHANIEL_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ATHANIEL_DEV_CREDITS), lowest priority,
