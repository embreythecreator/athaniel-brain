...
import { InputEvent } from '../../packages/athaniel-ink/src/ink/events/input-event.js'
import { INITIAL_STATE, parseMultipleKeypresses } from '../../packages/athaniel-ink/src/ink/parse-keypress.js'
...
// web/src/lib/pty-keyboard-shortcuts.ts). athaniel-ink decodes that bare
