...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@athaniel/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/athaniel-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/athaniel-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/athaniel-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/athaniel-ink/src/ink/dom.js'
import Output from '../../packages/athaniel-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/athaniel-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/athaniel-ink/src/ink/root.js'
