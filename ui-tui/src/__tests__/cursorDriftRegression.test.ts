 ...
 *
 * Symptom: in `athaniel --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@athaniel/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using athaniel --tui and as i type multiline my caret at the end will often ' +
