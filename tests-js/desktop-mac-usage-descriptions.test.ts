 ...
 *
 * Each entry is a key/value pair that lands in the packaged Athaniel.app's
 ...
 * "Athaniel wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Athaniel wants to access Music" when Athaniel never touches the Music
