#!/usr/bin/env python3
"""
SWE Runner with Athaniel Trajectory Format

A runner that uses Athaniel Brain's built-in execution environments
(local, docker, modal) and outputs trajectories in the Athaniel Brain format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Athaniel Brain's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Athaniel format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Athaniel Brain format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Athaniel Brain's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Athaniel Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Athaniel Brain's built-in execution environments
    and outputs trajectories in Athaniel Brain format.
    """
    ...
    def _convert_to_athaniel_format(
        self,
        ...
        """
        Convert internal message format to Athaniel trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Athaniel trajectory format
        trajectory = self._convert_to_athaniel_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Athaniel trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Athaniel Trajectory Format")
    print("=" * 60)
