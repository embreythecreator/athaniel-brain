...
cd apps/desktop
XCURSOR_SIZE=24 ATHANIEL_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/athaniel-typing
# → /tmp/athaniel-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/athaniel-typing.before.heapsnapshot
# → /tmp/athaniel-typing.after.heapsnapshot
```
