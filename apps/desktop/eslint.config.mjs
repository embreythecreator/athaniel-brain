...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @athaniel/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@athaniel/shared'],
              message: 'Plugins import only @athaniel/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
