/**
 * Athaniel skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ATHANIEL_HOME/skins/` (or a
 * built-in) resolved by `athaniel_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Athaniel authors from a prompt lights up all three surfaces from one file.
 *
...
import type { AthanielSkin, SkinColors } from '@athaniel/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: AthanielSkin): DesktopTheme | null {
