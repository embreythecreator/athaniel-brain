...
/**
 * Nous — the canonical Athaniel desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Athaniel's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Athaniel desktop identity: GitHub's chrome carrying Nous
