...
// (#73044). Exercises the REAL athaniel + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/athaniel')
...
const conn = (over: Partial<AthanielConnection> = {}): AthanielConnection =>
  ({
    authMode: 'oauth',
