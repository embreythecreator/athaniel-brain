...
import { transcribeAudio } from '@/athaniel'
...
export function usePromptActions({
  ...
  // succeeds on ATHANIEL01 and prompt.submit immediately fails locally with
  // "session not found".
  ...
  // separate `athaniel gateway` process performs the actual transfer, so we
