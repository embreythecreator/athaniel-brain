...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/athaniel'
...
const VERSION = 3
const PREFIX = 'HML' // "Athaniel Memory Loadout" — namespaces our codes like WoW's leading bytes.
