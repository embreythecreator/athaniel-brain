...
const FOCUS_EVENT = 'athaniel:composer-focus'
const INSERT_EVENT = 'athaniel:composer-insert'
const ATTACH_IMAGES_EVENT = 'athaniel:composer-attach-images'
const INSERT_REFS_EVENT = 'athaniel:composer-insert-refs'
const SUBMIT_EVENT = 'athaniel:composer-submit'
const VOICE_TOGGLE_EVENT = 'athaniel:composer-voice-toggle'
const MODEL_MENU_EVENT = 'athaniel:composer-model-menu'
