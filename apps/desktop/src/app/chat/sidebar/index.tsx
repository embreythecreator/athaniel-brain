...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/athaniel'
...
// highlight markers (sqlite snippet() delimiters — see athaniel_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('athaniel:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('athaniel:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Athaniel to
