...
import type { ProjectInfo, SessionInfo } from '@/athaniel'
 ...
 * repo shows its branches/worktrees even when they have no Athaniel sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: AthanielGitWorktree[]
): SidebarSessionGroup[] {
