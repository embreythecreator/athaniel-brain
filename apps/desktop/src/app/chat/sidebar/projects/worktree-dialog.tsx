...
import type { AthanielGitBranch } from '@/global'
...
const branchActionLabel = (branch: AthanielGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<AthanielGitBranch[]>([])
  ...
  const convert = async (branch: AthanielGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
