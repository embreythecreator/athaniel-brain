...
import { type DroppedFile, extractDroppedFiles, ATHANIEL_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, ATHANIEL_PATHS_MIME) ? 'files' : null
