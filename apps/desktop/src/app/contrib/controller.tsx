...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <athaniel home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('athaniel:open-keybinds'))
    } satisfies PaletteContribution
  },
    ...
    >
      <ContribWiring>
        ...
        <div
          ...
          // [data-athaniel-glass] rules in styles.css clear them so the tint
