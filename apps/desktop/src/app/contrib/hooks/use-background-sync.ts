...
import { getLatestSessionMessages, type ProfileScope } from '@/athaniel'
...
interface BackgroundSyncParams {
  ...
  refreshAthanielConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshAthanielConfig])
}
