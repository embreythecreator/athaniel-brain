...
import type * as AthanielApi from '@/athaniel'
...
vi.mock('@/athaniel', async importOriginal => ({
  ...(await importOriginal<typeof AthanielApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'athaniel-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://athaniel-brain.nousresearch.com'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { athanielDesktop?: unknown }).athanielDesktop = { connections, getAgentRoster }
