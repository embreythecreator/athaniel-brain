...
import { getAthanielConfigRecord, listAllProfileSessions } from '@/athaniel'
...
// Athaniel session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getAthanielConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-athaniel',
            keywords: ['update', 'upgrade', 'athaniel', 'version', 'system', 'restart'],
            label: cc.updateAthaniel,
