...
import { deleteLearningNode, type ProfileScope } from '@/athaniel'
import { type Translations, useI18n } from '@/i18n'
import { notify } from '@/store/notifications'

export const ARCHIVE_SKILL_DESCRIPTION = 'The skill is archived and can be restored with `athaniel curator restore`.'
