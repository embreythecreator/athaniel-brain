...
const searchCopy = {
  fieldDescriptions: {
    'display.personality': 'Choose how Athaniel sounds in conversation.',
...
describe('settings search index', () => {
  it('builds config results from renderable schema fields with exact deep links', () => {
    ...
    } as unknown as AthanielConfigRecord
    ...
    expect(entries[0]).toMatchObject({
      context: 'Chat',
      description: 'Choose how Athaniel sounds in conversation.',
      label: 'Personality',
