...
const RELEASE_NOTES_URL = 'https://github.com/embreythecreator/athaniel-brain/releases'
const INSTALLER_URL = 'https://athaniel-brain.nousresearch.com/'
                ...
                <Button asChild className="mt-2" size="sm" variant="textStrong">
                  <a
                    ...
                    onClick={event => {
                      ...
                      void window.athanielDesktop?.openExternal?.(INSTALLER_URL)
                    }}
                    rel="noreferrer"
                    target="_blank"
                  >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.athanielDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
