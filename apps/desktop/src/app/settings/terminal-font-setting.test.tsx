...
vi.mock('@/athaniel', () => ({
  saveAthanielConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setAthanielConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
