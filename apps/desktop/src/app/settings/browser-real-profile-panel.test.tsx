...
vi.mock('@/athaniel', () => ({
  saveAthanielConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  athanielConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useAthanielConfigRecord: () => ({ data: mocks.loadedConfig })
}))
