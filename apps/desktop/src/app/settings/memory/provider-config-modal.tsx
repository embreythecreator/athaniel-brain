...
import { saveMemoryProviderConfig } from '@/athaniel'
import { ExternalLink, Loader2, Save, SlidersHorizontal } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/athaniel'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.athanielDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
