...
import type { AthanielReadDirEntry, AthanielReadDirResult } from '@/global'
...
export type ProjectTreeEntry = AthanielReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: AthanielReadDirEntry) {
...
async function filterIgnored(entries: AthanielReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<AthanielReadDirResult> {
