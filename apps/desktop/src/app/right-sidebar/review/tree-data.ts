import type { AthanielReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AthanielReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AthanielReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
