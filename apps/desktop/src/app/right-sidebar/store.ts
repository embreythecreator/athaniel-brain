...
const TAKEOVER_KEY = 'athaniel.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Athaniel can't clear via the API — the user
 *  sees exactly what runs instead of Athaniel silently deleting their creds. */
