...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/embreythecreator/athaniel-brain/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/embreythecreator/athaniel-brain/pull/12345>')
