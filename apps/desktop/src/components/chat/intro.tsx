...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Athaniel look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Athaniel need to see?`,
    ...
    {
      headline: `What should ${label} Athaniel tackle?`,
