...
const STORAGE_KEY = 'athaniel.desktop.layoutTree.v2'

writeKey('athaniel.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('athaniel.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('athaniel.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'athaniel.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'athaniel.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'athaniel.desktop.hiddenStripTabs.v1'
...
writeKey('athaniel.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ATHANIEL_LAYOUT_TREE__ = {
    close: closeTreePane,
