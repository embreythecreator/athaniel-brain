...
export const ATHANIEL_CONTEXT_MENU_TRIGGER_ATTR = 'data-athaniel-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-athaniel-context-menu-trigger="" />
  )
}
