...
import type { ModelOptionsResponse, SessionInfo } from '@/types/athaniel'
 ...
 *
 * Only the leading status prefix (e.g. "Athaniel is thinking...") and the
 ...
 *  resolved comment as JSON (AthanielPrComment shape); a malformed payload falls
