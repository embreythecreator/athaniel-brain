...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|athaniel):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.athanielDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.athanielDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Athaniel, and it is the surface the agent
