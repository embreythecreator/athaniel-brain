...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/athaniel-brain')).toBe('~/www/athaniel-brain')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/athaniel-brain')).toBe('athaniel-brain')
    expect(pathLeaf('~/www/athaniel-brain')).toBe('athaniel-brain')
