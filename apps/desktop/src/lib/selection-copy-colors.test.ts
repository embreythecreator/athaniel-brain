...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.athanielMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.athanielMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.athanielMode = 'light'
