...
export function updateMessagingPlatform(
  ...
  return athanielApi<{ ok: boolean; platform: string }>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return athanielApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return athanielApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return athanielApi<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(profile),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return athanielApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return athanielApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return athanielApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return athanielApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
