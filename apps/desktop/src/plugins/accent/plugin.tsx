...
import type { AthanielPlugin, PaletteContribution } from '@athaniel/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@athaniel/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: AthanielPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
