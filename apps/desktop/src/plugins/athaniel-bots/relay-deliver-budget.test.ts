...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/athaniel-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'athaniel_cli/config_defaults.py'), 'utf8')
