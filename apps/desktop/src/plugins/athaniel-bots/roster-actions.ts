...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@athaniel/plugin-sdk'
 ...
 *  truth before it wins (athaniel-brain#90102): a persisted "Bot Chat" tile can
