 ...
 *    the primary profile surfaced as @default instead of @athaniel;
 ...
 *    kanban/tool workers count too (athaniel-brain#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @athaniel, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('athaniel')
