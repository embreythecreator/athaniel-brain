 ...
 * plugins resolve `@athaniel/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ATHANIEL_PLUGIN_SDK__: sdk,
  __ATHANIEL_REACT__: React,
  __ATHANIEL_REACT_JSX__: jsxRuntime,
  __ATHANIEL_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@athaniel/plugin-sdk': shimUrl('__ATHANIEL_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ATHANIEL_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ATHANIEL_REACT_JSX__'),
    react: shimUrl('__ATHANIEL_REACT__')
  }
