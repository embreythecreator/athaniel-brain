...
function identityForConnection(connection: AthanielConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: AthanielConnection | null): void {
