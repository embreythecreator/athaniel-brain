...
function installBridge(
  openSessionWindow?: Window['athanielDesktop']['openSessionWindow'],
  openWindow?: Window['athanielDesktop']['openWindow'],
  openBrowserWindow?: Window['athanielDesktop']['openBrowserWindow']
) {
