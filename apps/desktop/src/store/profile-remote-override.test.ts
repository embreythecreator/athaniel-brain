...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://athaniel.example.com:8443/x')).toBe('athaniel.example.com:8443')
    expect(remoteHostLabel('https://athaniel.example.com:443')).toBe('athaniel.example.com')
    expect(remoteHostLabel('http://athaniel.example.com:80')).toBe('athaniel.example.com')
  })
