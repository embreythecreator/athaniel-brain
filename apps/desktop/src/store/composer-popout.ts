...
const POPOUT_STORAGE_KEY = 'athaniel.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'athaniel.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'athaniel.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'athaniel.desktop.composerPopout.position'
