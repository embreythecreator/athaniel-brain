 ...
 * - It covers Athaniel too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('athaniel.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('athaniel.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('athaniel.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'athaniel.desktop.tips.next.v1',
  null,
