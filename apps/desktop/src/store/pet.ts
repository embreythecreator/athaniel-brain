...
export interface PetInfo {
  ...
  // the Athaniel "run" activity state uses the in-place running row).
 ...
 * ATHANIEL_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'athaniel.desktop.pet-roam.v1'
