...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('athaniel.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('athaniel.desktop.unreadFinishedSessions')
