 ...
 * unlike tips there is no ambient half to separate out — every tour is Athaniel
...
export const $toursEnabled = persistentAtom('athaniel.desktop.tours.v1', true, Codecs.bool)
