 ...
 * `<athaniel home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'athaniel.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'athaniel.desktop.disabledPlugins.v1'
