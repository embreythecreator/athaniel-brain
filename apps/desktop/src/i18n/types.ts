...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingAthanielDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshAthanielPathTitle: string
      sshAthanielPathDesc: string
      sshAthanielPathPlaceholder: string
  ...
  commandCenter: {
    ...
    athanielActiveSessions: (version: string, count: number) => string
