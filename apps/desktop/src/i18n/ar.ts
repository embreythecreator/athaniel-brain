...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `athaniel debug share --nous` من الطرفية، أو `athaniel debug share --local` لعرض التقرير دون رفعه.',
  ...
  boot: {
    ready: 'Athaniel Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات Athaniel',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم Athaniel البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingAthanielDesktop: 'جار تشغيل Athaniel Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية Athaniel الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية Athaniel الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية Athaniel أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateAthaniel: 'تحديث Athaniel',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل Athaniel Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر Athaniel ردّك.',
      turnDoneTitle: 'أنهى Athaniel',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات Athaniel؟',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها Athaniel). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون Athaniel في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح Athaniel سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان Athaniel في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      title: 'المظهر',
      intro: 'خصص مظهر Athaniel Desktop.',
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح Athaniel.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ Athaniel التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        'فقاعة صغيرة تشير إلى جزء من التطبيق، تظهر أحيانًا أثناء الخمول ومن Athaniel عند الحاجة. إغلاق نصيحة يزيلها نهائيًا.',
      tipsReset: count => `استعادة ${count} نصيحة مغلقة`,
      toursTitle: 'جولات إرشادية',
      toursDesc: 'دع Athaniel يرشدك في التطبيق، مع تعتيم الشاشة وإبراز كل خطوة.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله Athaniel — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق Athaniel وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج Athaniel إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف Athaniel التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع Athaniel قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل Athaniel مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث Athaniel نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول Athaniel',
      version: value => `الإصدار ${value}`,
      versionUnavailable: 'الإصدار غير متاح',
      bundleOutOfSync: 'إصدار التطبيق قديم',
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل Athaniel، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      ...
      automaticUpdatesDesc: 'اسمح لـ Athaniel بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات Athaniel...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح Athaniel.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل Athaniel Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية Athaniel تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc: 'أزل ATHANIEL_DESKTOP_REMOTE_URL و ATHANIEL_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية Athaniel خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية Athaniel بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /athaniel.',
      ...
      restartingMessage: 'سيعيد Athaniel Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · Athaniel ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى Athaniel. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من Athaniel.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل Athaniel تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل Athaniel لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث Athaniel لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك Athaniel عند الانتهاء.',
    ...
    athanielActiveSessions: (version, count) => `Athaniel ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: {
        ...
        placeholder: '@athaniel:example.org'
      },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'ستعمل جلسات هذا الملف الشخصي على خادم Athaniel البعيد الذي تحدده، بدلاً من هذا الجهاز.',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ Athaniel تغيير النموذج هذا.',
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل Athaniel تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها Athaniel تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من Athaniel أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من Athaniel. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم Athaniel لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء Athaniel...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل Athaniel عن شيء...', 'اطلب من Athaniel تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ Athaniel الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من Athaniel فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث Athaniel...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل Athaniel...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من Athaniel تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من Athaniel جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة Athaniel الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت Athaniel من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط Athaniel الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Athaniel لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث Athaniel المهمة في نافذته الخاصة ويعيد فتح Athaniel تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح Athaniel بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد Athaniel الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد Athaniel فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث Athaniel؟',
    blockerBody: 'يحتاج Athaniel إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث Athaniel',
    foreignBlockerBody:
      'لا يمكن لـ Athaniel إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ Athaniel إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج Athaniel إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل Athaniel',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من Athaniel CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ Athaniel قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت Athaniel بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك Athaniel Brain',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل Athaniel التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء Athaniel...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل Athaniel',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه Athaniel إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل Athaniel تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل Athaniel تلقائياً',
    ...
    authorizeThere: 'صرّح لـ Athaniel هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ Athaniel هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض Athaniel أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل Athaniel...',
      askRestart: 'اطلب من Athaniel إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث Athaniel عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل Athaniel في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من Athaniel فتح صفحة.',
      finishedRestarting: message => `أنهى Athaniel إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على Athaniel إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال Athaniel يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `athaniel gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها Athaniel عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'Athaniel بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه Athaniel',
      ...
      profiles: {
        ...
        text: 'كل واحد منها Athaniel مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {
