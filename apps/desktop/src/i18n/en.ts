...
export const en: Translations = {
  ...
  boot: {
    ready: 'Athaniel Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Athaniel settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Athaniel backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingAthanielDesktop: 'Starting Athaniel Desktop…'
    },
    errors: {
      backgroundExited: 'Athaniel background process exited.',
      backgroundExitedDuringStartup: 'Athaniel background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Athaniel backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateAthaniel: 'Update Athaniel',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Athaniel Desktop.',
    ...
    native: {
      ...
      inputBody: 'Athaniel is waiting for your response.',
      turnDoneTitle: 'Athaniel finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `athaniel debug share --nous` from a terminal, or `athaniel debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Athaniel defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Athaniel backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Athaniel backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.athaniel/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Athaniel is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Athaniel asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Athaniel was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Athaniel was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Athaniel follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Athaniel can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Athaniel when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Athaniel walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Athaniel is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Athaniel, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Athaniel Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Athaniel runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Athaniel checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Athaniel configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Athaniel.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Athaniel gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Athaniel Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Athaniel Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Athaniel runtime managed by this app.',
      kindRemoteDesc: 'A Athaniel gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Athaniel Cloud account.',
      kindSshDesc: 'A Athaniel install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Athaniel manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Athaniel Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Athaniel backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset ATHANIEL_DESKTOP_REMOTE_URL and ATHANIEL_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Athaniel backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Athaniel backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Athaniel Cloud',
      cloudDesc: 'Sign in once to Athaniel Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Athaniel Cloud',
      cloudSignIn: 'Sign in to Athaniel Cloud',
      cloudSignedIn: 'Signed in to Athaniel Cloud',
      cloudNeedsSignIn: 'Sign in to Athaniel Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Athaniel Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Athaniel Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Athaniel Cloud',
      cloudSignedOutMessage: 'Cleared the Athaniel Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /athaniel.',
      ...
      restartingMessage: 'Athaniel Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Athaniel ${version}` : ''}`,
      ...
      sshDesc:
        'Athaniel is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshAthanielPathTitle: 'Athaniel path (optional)',
      sshAthanielPathDesc: 'Full path to the remote athaniel binary. Blank = auto-detect.',
      sshAthanielPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Athaniel found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Athaniel runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Athaniel is not installed on the remote host. Install it there (curl -fsSL https://athaniel-brain.nousresearch.com/install.sh | sh) or set the Athaniel path.',
      sshErrPlatform:
        'Unsupported remote platform. Athaniel Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Athaniel on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Athaniel. Review the exact configuration below — it comes from the link, not from Athaniel.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Athaniel runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Athaniel at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via athaniel curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Athaniel builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Athaniel to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Athaniel to generate pets.',
      backgroundHint: 'You can close this — Athaniel will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Athaniel desktop' },
    ...
    athanielActiveSessions: (version, count) => `Athaniel ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@athaniel:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Athaniel you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://athaniel.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Athaniel environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Athaniel did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Athaniel will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Athaniel backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Athaniel. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Athaniel backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Athaniel...',
    placeholderReconnecting: 'Reconnecting to Athaniel…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Athaniel a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Athaniel will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Athaniel to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Athaniel…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Athaniel…',
    ...
    unsupportedMessage: 'This version of Athaniel can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Athaniel from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Athaniel will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Athaniel desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Athaniel updater takes over in its own window and reopens Athaniel automatically when it’s done. Please don’t reopen Athaniel yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Athaniel reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Athaniel reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Athaniel?',
    blockerBody:
      'Athaniel needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Athaniel',
    foreignBlockerBody:
      'Athaniel can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Athaniel can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Athaniel needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Athaniel Desktop',
    setupChoiceDesc:
      'Connect this app to a Athaniel gateway you already run, or install Athaniel locally on this computer.',
    connectExistingTitle: 'Connect to existing Athaniel',
    ...
    installLocalTitle: 'Install Athaniel locally',
    installLocalDesc: 'Download Athaniel, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Athaniel Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Athaniel',
    remoteSetupDesc: 'Enter your gateway URL. Athaniel Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Athaniel gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/athaniel',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Athaniel gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Athaniel Brain',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Athaniel CLI or desktop instance is running. Stop any running Athaniel instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Athaniel Brain",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Athaniel is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Athaniel…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Athaniel',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Athaniel at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Athaniel connects automatically',
    ...
    authorizeThere: 'Authorize Athaniel there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Athaniel there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Athaniel Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Athaniel Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Athaniel will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Athaniel is restarting...',
      askRestart: 'Ask Athaniel to restart the server',
      lookingRestart: taskId => `Athaniel is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Athaniel is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Athaniel to open a page.',
      finishedRestarting: message => `Athaniel finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Athaniel could not restart the server.',
      stillWorking:
        'Athaniel is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Athaniel is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Athaniel gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.athaniel/config.yaml). Athaniel won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Athaniel needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Athaniel needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Athaniel Desktop to use Save Image.',
    restartToSaveImages: 'Restart Athaniel Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `athaniel gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Athaniel loads when the work calls for them.'
      },
      messaging: {
        title: 'Athaniel away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Athaniel made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Athaniel — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
