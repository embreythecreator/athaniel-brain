...
const emojibaseAssets = () => ({
  name: 'athaniel:emojibase-assets',
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\athaniel\athaniel-brain\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@athaniel/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@athaniel/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@athaniel/shared': path.resolve(__dirname, '../shared/src'),
