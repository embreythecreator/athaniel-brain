...
How to build Athaniel Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Athaniel surface can also
...
- A **runtime home change** (switching the underlying `ATHANIEL_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Athaniel — do not assume
