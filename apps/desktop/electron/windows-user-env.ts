...
// even though a fresh shell — and the Athaniel CLI — sees it immediately. The
// desktop's ATHANIEL_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\athaniel. Reading
...
//       ATHANIEL_HOME    REG_SZ    F:\Athaniel\data
//
