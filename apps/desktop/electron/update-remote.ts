 ...
 *
 * A public install can end up with `origin=git@github.com:embreythecreator/athaniel-brain.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/embreythecreator/athaniel-brain.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/embreythecreator/athaniel-brain'
