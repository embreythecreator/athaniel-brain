...
test('rewrites an archived node-pty root to the matching unpacked tree exactly once', () => {
  assert.equal(
    writableNodePtyRoot('/Athaniel.app/Contents/Resources/app.asar/dist/node_modules/node-pty'),
    '/Athaniel.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'
  )
  assert.equal(
    writableNodePtyRoot('/Athaniel.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'),
    '/Athaniel.app/Contents/Resources/app.asar.unpacked/dist/node_modules/node-pty'
  )
})

test('uses the unpacked helper when resolution reports an app.asar node-pty root', () => {
  const archivedRoot = '/Athaniel.app/Contents/Resources/app.asar/dist/node_modules/node-pty'
