 ...
 *
 * 1. TORN BUNDLE after an update (#95575): `athaniel update` replaces the app
...
export interface RendererLoadErrorDetails {
  ...
  /** Repair command hint, e.g. `athaniel desktop --force-build`. */
  repairHint?: string
  /**
...
export function buildRendererLoadErrorPage(details: RendererLoadErrorDetails = {}): string {
  ...
  const title = 'Athaniel couldn\u2019t start the desktop UI'
  ...
  const repair = details.repairHint ? `<p>Repair with: <code>athaniel desktop --force-build</code></p>` : ''
...
<main>
  ...
  <code>athaniel desktop --force-build</code>, then restart the app.</p>
