...
// by main.ts (`setBackgroundThrottling` driven by the merged `athaniel:active-work`
...
// (the "Athaniel idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Athaniel" wake word has NO preceding click,
