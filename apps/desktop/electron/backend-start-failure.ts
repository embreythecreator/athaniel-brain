 ...
 * startAthaniel() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startAthaniel() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startAthaniel`, re-emits
