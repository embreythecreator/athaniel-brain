...
export function registerHudIpc({
  ...
  ipcMain.on('athaniel:hud:native-drag', event => {
    event.returnValue = hudWindowing().move === 'native-drag'
  })

  ipcMain.on('athaniel:hud:windowing', event => {
  ...
  ipcMain.on('athaniel:hud:workspace-transfer', (event, transferring) => {
  ...
  ipcMain.handle('athaniel:hud:open', async (_event, request) => {
    openHudWindow(
  ...
  ipcMain.handle('athaniel:hud:frost', (_event, showing) => {
  ...
  // reaches the bar.
  ipcMain.on('athaniel:hud:ignore-mouse', (_event, ignore) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('athaniel:hud:begin-move', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('athaniel:hud:end-move', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('athaniel:hud:move-by', (event, delta) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('athaniel:hud:set-bounds', (event, bounds) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('athaniel:hud:reset-layout', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('athaniel:hud:session', (event, sessionId) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('athaniel:hud:close', async () => {
    closeHudWindow()
