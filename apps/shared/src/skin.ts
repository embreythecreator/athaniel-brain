/**
 * Canonical Athaniel skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ATHANIEL_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`athaniel_cli/skin_engine.py`),
 ...
 *   • CLI     → `athaniel_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
