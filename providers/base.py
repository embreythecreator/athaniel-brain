...
def _profile_user_agent() -> str:
    """Return a ``athaniel-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from athaniel_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"athaniel-cli/{_ver}"
    except Exception:
        return "athaniel-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # athaniel-cli UA so the catalog endpoint is reachable.
