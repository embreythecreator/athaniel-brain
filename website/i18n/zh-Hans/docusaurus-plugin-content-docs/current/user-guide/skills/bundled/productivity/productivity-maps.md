...
脚本路径：`~/.athaniel/skills/maps/scripts/maps_client.py`
...
```bash
python3 ~/.athaniel/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# 应返回纬度约 40.689，经度约 -74.044

python3 ~/.athaniel/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
