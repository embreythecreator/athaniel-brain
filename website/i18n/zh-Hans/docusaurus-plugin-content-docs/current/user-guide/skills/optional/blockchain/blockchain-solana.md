...
| | |
|---|---|
| 来源 | 可选 — 通过 `athaniel skills install official/blockchain/solana` 安装 |
| 路径 | `optional-skills/blockchain/solana` |
| 版本 | `0.2.0` |
| 作者 | Deniz Alagoz (gizdusum)，由 Athaniel Brain 增强 |
| 许可证 | MIT |
...
辅助脚本路径：~/.athaniel/skills/blockchain/solana/scripts/solana_client.py
...
# 确认连通性
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
