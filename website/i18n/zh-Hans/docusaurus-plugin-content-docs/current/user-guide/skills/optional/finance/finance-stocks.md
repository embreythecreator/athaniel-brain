...
| | |
|---|---|
| 来源 | 可选 — 使用 `athaniel skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Athaniel Brain |
| 许可证 | MIT |
...
```
python3 ~/.athaniel/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
