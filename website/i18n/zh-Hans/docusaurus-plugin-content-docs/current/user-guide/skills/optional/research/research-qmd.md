...
| | |
|---|---|
| 来源 | 可选 — 通过 `athaniel skills install official/research/qmd` 安装 |
...
| 相关 skill | [`obsidian`](/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`athaniel-brain`](/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athaniel-brain), [`arxiv`](/user-guide/skills/bundled/research/research-arxiv) |
...
qmd 提供 MCP 服务器，可通过原生 MCP 客户端直接向 Athaniel Brain 提供搜索工具。这是推荐的集成方式 — 配置完成后，agent 无需每次加载此 skill 即可自动获得 qmd 工具。
...
然后配置 Athaniel Brain 通过 HTTP 连接：
