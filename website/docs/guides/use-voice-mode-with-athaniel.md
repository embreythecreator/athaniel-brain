---
sidebar_position: 8
title: "Use Voice Mode with Athaniel"
description: "A practical guide to setting up and using Athaniel voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Athaniel
...
- you want Athaniel sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Athaniel.
...
## Step 1: make sure normal Athaniel works first
...
Athaniel supports both local and cloud speech stacks.
...
4. Athaniel transcribes and responds
...
- asking Athaniel to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Athaniel loop.

## Tuning CLI behavior

### Silence threshold

If Athaniel starts/stops too aggressively, tune:
...
Athaniel stays a normal chat bot, but can speak replies.
...
- you want Athaniel to function like a portable research or ops assistant
...
Athaniel joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Athaniel detects speech boundaries
- transcripts are posted in the associated text channel
- Athaniel responds in text and audio
...
1. get text Athaniel working
2. run `athaniel setup tts` to enable voice support
