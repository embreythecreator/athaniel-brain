...
description: "How the Athaniel Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Athaniel Desktop app connects to a **gated gateway** (a hosted or
...
For Athaniel specifically, native sign-in means:
...
- [Run Athaniel with Nous Portal](./run-athaniel-with-nous-portal.md)
