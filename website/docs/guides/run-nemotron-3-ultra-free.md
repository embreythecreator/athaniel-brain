---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Athaniel Brain"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Athaniel Brain"
---

# Run Nemotron 3 Ultra free in Athaniel Brain

Athaniel has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Nous Portal](https://portal.nousresearch.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Athaniel Brain today.
...
[Download the Athaniel Desktop installer](https://athaniel-brain.embreythecreator.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize Athaniel. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://athaniel-brain.embreythecreator.com/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Athaniel opens a browser tab and waits for you to finish the next steps.
...
When prompted to connect your account to Athaniel Brain, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `athaniel portal info` confirms you're logged in and routing through Nous.
...
- **[Run Athaniel Brain with Nous Portal](/guides/run-athaniel-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
