...
| [`athaniel-brain`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athaniel-brain) | Use, configure, theme, extend, and orchestrate Athaniel Brain. | `autonomous-ai-agents\athaniel-brain` |
...
| [`athaniel-brain-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-athaniel-brain-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\athaniel-brain-skill-authoring` |
| [`inspecting-athaniel-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-athaniel-desktop-dom) | Read the live Athaniel desktop DOM/CSS over CDP. | `software-development\inspecting-athaniel-desktop-dom` |
