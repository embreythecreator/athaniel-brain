...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`athaniel-brain`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athaniel-brain) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Athaniel terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Athaniel itself, `model.provider: openai-codex` uses Athaniel-managed Codex
OAuth from `~/.athaniel/auth.json` after `athaniel auth add openai-codex`. For the
...
## Athaniel Gateway Caveat

When invoking the Codex CLI from a Athaniel gateway/service context (for example,
