...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Athaniel Brain |
| License | MIT |
...
import upstream classes into Athaniel itself.
...
```bash
mkdir -p ~/.athaniel/cache/darwinian-evolver && cd ~/.athaniel/cache/darwinian-evolver
...
```bash
cd ~/.athaniel/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.athaniel/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.athaniel/skills/research/darwinian-evolver
DE_DIR=~/.athaniel/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Athaniel core.
   Custom driver scripts under `~/.athaniel/skills/...` are user-side and fine.
