...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/research/gitnexus-explorer` |
...
| Related skills | [`athaniel-brain`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athaniel-brain), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  athaniel-brain users don't need.
