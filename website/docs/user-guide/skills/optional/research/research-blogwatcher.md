...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/research/blogwatcher` |
...
## Working with Athaniel tools (read this first)

`blogwatcher-cli` is the feed database; Athaniel tools do the automation around it:
