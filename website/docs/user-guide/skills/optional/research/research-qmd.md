...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`athaniel-brain`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-athaniel-brain), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Athaniel Brain via the native MCP client. This is the preferred
...
Then configure Athaniel Brain to connect via HTTP:
