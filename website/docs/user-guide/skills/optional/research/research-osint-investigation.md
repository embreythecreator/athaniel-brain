...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Athaniel Brain (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ATHANIEL_OSINT_CACHE/icij/ (default: ~/.cache/athaniel-osint/icij/).
...
# Set ATHANIEL_OSINT_UA=your-app/1.0 (your@email) to identify yourself
