...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/productivity/decision-questionnaire` |
| Path | `optional-skills/productivity\decision-questionnaire` |
| Version | `1.0.0` |
| Author | Matt Pocock (mattpocock/skills, to-questionnaire) + Athaniel Brain |
| License | MIT |
