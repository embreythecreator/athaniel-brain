...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/productivity/shopify` |
...
4. Save to `${ATHANIEL_HOME:-~/.athaniel}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Athaniel","productType":"Apparel","tags":["test"]}}'
```
