...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/web-development/page-agent` |
...
- User wants **Athaniel itself to drive a browser** → use Athaniel' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
