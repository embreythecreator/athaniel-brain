...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/creative/simple-english` |
| Path | `optional-skills/creative\simple-english` |
| Version | `1.2.0` |
| Author | AminBlg (https://github.com/AminBlg/SimpleEnglish), ported by Athaniel Brain |
| License | MIT |
