...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/creative/impeccable` |
...
> ships and verifies a Athaniel-native skill bundle under `.athaniel/skills/`.
> `athaniel skills install impeccable` pulls the current bundle live from that
