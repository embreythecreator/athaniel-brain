...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Athaniel Brain |
| License | MIT |
...
```bash
python -m pyfiglet "ATHANIEL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ATHANIEL&font=Slant" | boxes -d stone
```
