...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development\subagent-driven-development` |
| Version | `1.1.0` |
| Author | Athaniel Brain (adapted from obra/superpowers) |
| License | MIT |
