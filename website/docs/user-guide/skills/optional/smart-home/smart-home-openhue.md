...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/smart-home/openhue` |
...
- Bridge must be on the same local network as the machine running Athaniel
