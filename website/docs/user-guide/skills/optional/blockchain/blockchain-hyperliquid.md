...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Athaniel Brain |
| License | MIT |
...
The script reads `${ATHANIEL_HOME:-~/.athaniel}/.env` for two optional defaults:
...
Helper script: `~/.athaniel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.athaniel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ATHANIEL_HOME:-~/.athaniel}/.env`.
...
```bash
python ~/.athaniel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.athaniel/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
