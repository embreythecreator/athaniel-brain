...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Athaniel Brain |
| License | MIT |
...
Helper script path: ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.athaniel/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
