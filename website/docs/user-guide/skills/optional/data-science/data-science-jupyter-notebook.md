...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing athaniel tool access (web_search, file ops). Stateless. |
