...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Athaniel Brain |
| License | MIT |
...
```
SCRIPT=~/.athaniel/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.athaniel/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
