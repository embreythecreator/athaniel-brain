...
| | |
|---|---|
| Source | Optional — install with `athaniel skills install official/health/neuroskill-bci` |
...
Connect Athaniel to a running [NeuroSkill](https://neuroskill.com/) instance to read
