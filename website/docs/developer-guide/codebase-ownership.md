...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `athaniel_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `athaniel_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Athaniel Plugin](plugins/index.md) |
...
| Session storage | `athaniel_state.py` | [Session Storage](session-storage.md) |
