...
slug: /
sidebar_position: 0
title: "Athaniel Brain Documentation"
description: "The self-improving AI agent built by Athaniel. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Athaniel](https://embreythecreator.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `athaniel setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is Athaniel Brain?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Athaniel safely  |
| 🧭 **[Use MCP with Athaniel](/guides/use-mcp-with-athaniel)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Athaniel](/guides/use-voice-mode-with-athaniel)** | Hands-on setup and usage patterns for Athaniel voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Athaniel' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Athaniel                              |
...
- **Built by model trainers** — Created by [Athaniel](https://embreythecreator.com), the lab behind Athaniel, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Athaniel](https://embreythecreator.com) — the lab behind Athaniel, Nomos, and Psyche models
