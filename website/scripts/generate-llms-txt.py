#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Athaniel docs site.
...
LLM reads to learn what Athaniel does.

Both publish at:
  https://athaniel-brain.embreythecreator.com/docs/llms.txt
  https://athaniel-brain.embreythecreator.com/docs/llms-full.txt
...
SITE_BASE = "https://athaniel-brain.embreythecreator.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Athaniel as a Python Library", None),
        ("guides/use-mcp-with-athaniel", "Use MCP with Athaniel", None),
        ("guides/use-voice-mode-with-athaniel", "Use Voice Mode with Athaniel", None),
        ("guides/use-soul-with-athaniel", "Use SOUL.md with Athaniel", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Athaniel"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Athaniel Brain")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Athaniel. A terminal-native "
    ...
    lines.append(
        ...
        "athaniel-brain/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/embreythecreator/athaniel-brain")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Athaniel Brain — Full Documentation\n",
        (
            "This file is the entire Athaniel Brain documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Athaniel, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://athaniel-brain.embreythecreator.com/docs\n",
        "Short index: https://athaniel-brain.embreythecreator.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
