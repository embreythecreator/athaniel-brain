  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Athaniel Brain community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Athaniel &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Athaniel?{' '}
        <a
          href="https://github.com/embreythecreator/athaniel-brain/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
