...
batch (tracker: [#77056](https://github.com/embreythecreator/athaniel-brain/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Athaniel home, same model, same tasks, same reps.
...
1. Create a dedicated Athaniel home with credentials for the models under test:
   ...
   integration at it; no Athaniel observability plugin needs to be enabled.
