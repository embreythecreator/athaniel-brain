#!/usr/bin/env python3
"""Build the Athaniel Model Catalog — a centralized JSON manifest of curated models.
...
Athaniel CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Athaniel release.
...
# Ensure ATHANIEL_HOME is set for imports that touch it at module level.
os.environ.setdefault("ATHANIEL_HOME", os.path.join(os.path.expanduser("~"), ".athaniel"))

from athaniel_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "athaniel-brain repo",
            "docs": "https://athaniel-brain.embreythecreator.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Athaniel '
