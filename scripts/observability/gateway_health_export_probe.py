...
def main() -> None:
    ...
    athaniel_home = Path(tempfile.mkdtemp(prefix="athaniel-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "athaniel-gateway-smoke",
    ...
    print(json.dumps({"athaniel_home": str(athaniel_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
