#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Athaniel logs.
...
With no LOGFILE, reads ``$ATHANIEL_HOME/logs/agent.log`` (default ~/.athaniel).
...
def default_log() -> Path:
    home = os.environ.get("ATHANIEL_HOME") or str(Path.home() / ".athaniel")
