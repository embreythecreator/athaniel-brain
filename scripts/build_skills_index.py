#!/usr/bin/env python3
"""Build the Athaniel Skills Index — a centralized JSON catalog of all skills.
...
`athaniel skills search/install` can use it without hitting the GitHub API.
...
# Ensure ATHANIEL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Athaniel Skills Index...", flush=True)
