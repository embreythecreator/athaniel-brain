...
VERSION_FILE = REPO_ROOT / "athaniel_cli" / "__init__.py"
...
LEGACY_AUTHOR_MAP = {
    ...
    "pi@athaniel.local": "Elektrofussel",  # PR #61675 salvage (honcho: defaultHost + private-range local URL detection)
    ...
    "kavi@local.athaniel": "kavioavio",  # Issue #46544 / PR #47705 evolution (smart DENY exact-operation owner override)
    ...
    "sunsky.lau@gmail.com": "liuhao1024",  # PR #56993 salvage (gateway: process-level ATHANIEL_HOME for pid/lock/status identity files; #56986)
    ...
    "wyuebei@gmail.com": "wyuebei-cloud",  # PR #56640 salvage (athaniel journey: replace GNU-only %-d strftime with dt.day for Windows)
    ...
    "athaniel.wanderer@yahoo.com": "trismegistus-wanderer",  # PR #31856 salvage (gateway: defer idle-TTL agent-cache eviction until the session store says the session actually expired, so the expiry watcher can still fire MemoryProvider.on_session_end with the live transcript; #11205)
    ...
    "me@keslerm.com": "keslerm",  # PR #3459 salvage (gateway: 'log' tool_progress mode — silent in chat, tool calls appended to ~/.athaniel/logs/tool_calls.log via rotating handler; duplicate of #3458 by @dlkakbs who submitted 4 min earlier — both credited)
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows athaniel-shim resolution + prefer --update on recovery; #52378)
    ...
    "athaniel@marian.local": "Schrotti77",
    ...
    "274096618+athaniel-brain-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "athaniel@nousresearch.com": "embreythecreator",
    ...
    "sberan@gmail.com": "sberan",  # PR #54494 salvage (--connect-timeout flag on athaniel mcp add)
    ...
    "athaniel@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "teknium@athaniel-brain": "teknium1",
    ...
    "github@nadyaathaniel.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (ATHANIEL_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (ATHANIEL_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: athaniel-eval community link)
    ...
    "athanielagent26@gmail.com": "athanielagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+athanielagent26@users.noreply.github.com": "athanielagent26",
    ...
    "vigo@athaniel": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.athaniel@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Athaniel runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level ATHANIEL_HOME state files)
    ...
    "zhchl@athaniel-brain.local": "8294",  # PR #50572 salvage (honor config context_length on banner)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Athaniel
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "athaniel@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/embreythecreator/athaniel-brain",
    ...
    lines.append(f"# Athaniel Brain v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Athaniel Brain. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Athaniel Brain Release Tool")
    ...
    print(f"{'='*60}")
    print("  Athaniel Brain Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Athaniel Brain v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Athaniel Brain v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Athaniel Brain v{new_version} ({calver_date})' "
