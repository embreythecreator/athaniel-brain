...
Registry of record: `athaniel_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Athaniel config+state snapshots (CLI)
...
/update                  Update Athaniel to latest
