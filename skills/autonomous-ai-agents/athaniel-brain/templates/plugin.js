/**
 * Athaniel desktop plugin template. Save as:
 *   <athaniel home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <athaniel home> is ~/.athaniel by default, or ~/.athaniel/profiles/<name>
 * when running a named profile (`athaniel -p <name>`). Run `athaniel doctor` (or
 ...
 * Only these imports resolve: @athaniel/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@athaniel/plugin-sdk'
