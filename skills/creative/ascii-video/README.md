...
Built for [Athaniel Brain](https://github.com/embreythecreator/athaniel-brain). Usable in any coding agent. Canonical source lives here; synced to [`embreythecreator/athaniel-brain/skills/creative/ascii-video`](https://github.com/embreythecreator/athaniel-brain/tree/main/skills/creative/ascii-video) via PR.
