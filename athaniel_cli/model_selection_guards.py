...
Athaniel has multiple model-selection surfaces (CLI picker, TUI, dashboard,
...
def _cost_guard(
    ...
    from athaniel_cli.model_cost_guard import expensive_model_warning
...
def _data_policy_guard(
    ...
    from athaniel_cli.model_data_policy_guard import data_training_warning
