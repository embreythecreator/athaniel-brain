...
``athaniel sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Athaniel session database.
...
# Athaniel session ids are timestamps: 20260812_135332_ab12cd. This is the
...
def _cli_supports_recover(binary: str) -> bool:
    ...
    scratch_dir = tempfile.mkdtemp(prefix="athaniel-recover-probe-")
