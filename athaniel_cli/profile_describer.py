...
Used by ``athaniel profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``athaniel_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Athaniel Brain kanban board.
...
Rules:
  ...
  - Never write "Athaniel Brain profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_athaniel_home())
        else:
