...
key tuples Athaniel already binds.
...
def install_keypress_data_normalization() -> int:
    ...
    if getattr(
        _vt100_mod.Vt100Parser._call_handler, "_athaniel_char_data_normalized", False
    ):
        return 0
    ...
    _patched_call_handler._athaniel_char_data_normalized = True
...
def install_shift_enter_alias() -> int:
    ...
    at the application layer — the sequences above never reach Athaniel.
