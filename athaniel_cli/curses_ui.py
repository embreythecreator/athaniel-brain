"""Shared curses-based UI components for Athaniel CLI.

Used by `athaniel tools` and `athaniel skills` for interactive checklists.
...
_MENU_NAVIGATION_HANDLER: ContextVar[MenuNavigationHandler | None] = ContextVar(
    "athaniel_menu_navigation_handler", default=None
)
_NUMBERED_BACK_ENABLED: ContextVar[bool] = ContextVar(
    "athaniel_numbered_back_enabled", default=False
)
