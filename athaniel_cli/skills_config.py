"""
Skills configuration for Athaniel Brain.
`athaniel skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.athaniel/config.yaml under:
...
from athaniel_cli.config import cfg_get, load_config, save_config
from athaniel_cli.colors import Colors, color
from athaniel_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    ...
    Essential skills (e.g. ``athaniel-brain``) are silently dropped from the
...
def skills_command(args=None):
    """Entry point for `athaniel skills`."""
    from athaniel_cli.curses_ui import curses_checklist
