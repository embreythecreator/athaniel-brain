"""Client for uploading ``athaniel debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``athaniel debug share``.
...
NAS_BASE = os.environ.get(
    "ATHANIEL_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "athaniel-brain/debug-share"
