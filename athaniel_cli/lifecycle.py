"""Athaniel lifecycle dispatch for first-party observers and plugins."""
...
def invoke_hook(hook_name: str, **kwargs: Any) -> List[Any]:
    ...
    try:
        from athaniel_cli.observability import observe_lifecycle
...
def has_hook(hook_name: str) -> bool:
    ...
    try:
        from athaniel_cli.observability import handles_hook
