...
_RECOVERY_ENV = "ATHANIEL_UPDATE_RESTART_RECOVERY"
_GATEWAY_MARKERS = ("_ATHANIEL_GATEWAY", "ATHANIEL_GATEWAY", "ATHANIEL_GATEWAY_MODE")
...
def _systemd_unit_candidates(profile: str) -> tuple[str, ...]:
    ...
    return (
        f"athaniel-gateway-{profile}.service",
