...
Invoked by ``athaniel kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Athaniel Brain board.
...
def _profile_author() -> str:
    """Mirror of ``athaniel_cli.kanban._profile_author``."""
    return (
