...
Visual styling mirrors the Athaniel design system (the
...
``tests/athaniel_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Athaniel Brain</title>
<style>
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Athaniel Brain dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Athaniel Brain</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
...
See the <a href="https://athaniel-brain.nousresearch.com/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
