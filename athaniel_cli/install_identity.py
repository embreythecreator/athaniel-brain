"""Stable opaque identity shared by every profile in one Athaniel install."""
...
def read_or_create_install_id(root: Path | None = None) -> Optional[str]:
    ...
    """
    root = get_default_athaniel_root() if root is None else root
...
def get_install_id(
    *,
    ...
    """Return the process-cached stable id for the active Athaniel root."""
