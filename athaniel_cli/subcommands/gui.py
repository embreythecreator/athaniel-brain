"""``athaniel gui`` subcommand parser.
...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description=(
            "Launch the Athaniel Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--ignore-existing",
        action="store_true",
        help="Force Desktop to ignore any athaniel CLI already on PATH during backend resolution",
    )
    gui_parser.add_argument(
        "--athaniel-root",
        help="Override the Athaniel source root used by Desktop (sets ATHANIEL_DESKTOP_ATHANIEL_ROOT)",
    )
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ATHANIEL_DESKTOP_CWD)",
    )
    gui_parser.add_argument(
        "--skip-build",
        action="store_true",
    ...
    gui_parser.add_argument(
        "--identity",
        default="Athaniel Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Athaniel Local Signing)",
    )
