"""``athaniel uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Athaniel Brain",
        description="Remove Athaniel Brain from your system. Can keep configs/data for reinstall.",
    )
