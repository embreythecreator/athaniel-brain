"""``athaniel tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'athaniel tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # athaniel tools list [--platform cli]
    ...
    # athaniel tools disable <name...> [--platform cli]
    ...
    # athaniel tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `athaniel tools` runs after you pick a provider that\n"
