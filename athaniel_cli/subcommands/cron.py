"""``athaniel cron`` subcommand parser.

Extracted verbatim from ``athaniel_cli/main.py:main()`` — same arguments, same
...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.athaniel/scripts/. Default mode: "
    ...
    cron_create.add_argument(
        ...
        help=(
            ...
            "~/.athaniel/scripts/ that runs each tick BEFORE the agent. "
    ...
    cron_edit.add_argument(
        "--script",
        help=(
            "Path to a script under ~/.athaniel/scripts/. Pass empty string to clear. "
    ...
    cron_edit.add_argument(
        ...
        dest="monitor_script",
        help=(
            "Set/replace the monitor source script (see `athaniel cron create "
