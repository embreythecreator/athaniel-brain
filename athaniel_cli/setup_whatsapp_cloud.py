...
Entry point: ``athaniel whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``athaniel_cli/main.py``).
...
Athaniel gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Athaniel to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Athaniel needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Athaniel gateway in another terminal:")
    print("         athaniel gateway")
    print()
    ...
    print()
    print("  Docs: https://athaniel-brain.embreythecreator.com/docs/user-guide/")
