...
``athaniel update`` mutation (CLI apply, CLI --check, dashboard update
endpoint). The decision layers:

1. **Baked provenance marker** (``/etc/athaniel/image-provenance.json``,
   written by the image build — see :mod:`athaniel_cli.image_provenance`):
