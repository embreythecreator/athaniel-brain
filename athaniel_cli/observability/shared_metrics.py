"""Durable aggregation and local export for Athaniel shared metrics."""
...
from athaniel_cli.sqlite_util import write_txn
...
_PACKAGE_SCHEMA_VERSION = "athaniel.shared_metrics.v2"
...
class SharedMetricsStore:
    ...
    def __init__(
        ...
        root = get_athaniel_home() / "telemetry" / "shared_metrics"
        ...
        return [
            {
                ...
                "resource": {
                    "athaniel_version": row["athaniel_version"],
    ...
    def _ensure_schema(self) -> None:
        with self._connection(busy_timeout_ms=_SCHEMA_BUSY_TIMEOUT_MS) as connection:
            # Serialize first-run creation and upgrades across Athaniel processes.
            with write_txn(connection):
    ...
    def _create_package_in_transaction(
        ...
        resource = {
            "athaniel_version": period_row["athaniel_version"],
