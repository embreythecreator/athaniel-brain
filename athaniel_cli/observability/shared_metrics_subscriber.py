"""Relay subscriber for the persisted Athaniel shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Athaniel counters from Relay lifecycle events."""

    def __init__(
        self,
        store: SharedMetricsStore,
        athaniel_version: str,
        *,
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Athaniel shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
