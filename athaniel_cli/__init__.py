"""
Athaniel CLI - Unified command-line interface for Athaniel Brain.

Provides subcommands for:
- athaniel chat          - Interactive chat (same as ./athaniel)
- athaniel gateway       - Run gateway in foreground
- athaniel gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `athaniel setup` on a fresh Pi.
    ...
    athaniel_cli/stdio.py::configure_windows_stdio() runs later from the entry
