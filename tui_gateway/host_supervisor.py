...
def _default_registry_path() -> Path:
    return get_athaniel_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_athaniel_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_athaniel_home = expected_athaniel_home if expected_athaniel_home is not None else str(get_athaniel_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["ATHANIEL_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("athaniel_home") or "")
        if got_home and got_home != self.expected_athaniel_home:
            raise RuntimeError(f"compute host ATHANIEL_HOME mismatch: {got_home} != {self.expected_athaniel_home}")
