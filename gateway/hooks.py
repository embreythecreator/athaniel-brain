...
Hooks are discovered from ~/.athaniel/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Athaniel session id
...
HOOKS_DIR = get_athaniel_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"athaniel_hook_{hook_name}"
