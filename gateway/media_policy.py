...
from environment variables:
  ...
  - ``ATHANIEL_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``ATHANIEL_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``ATHANIEL_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``athaniel cron run`` in the CLI, ``athaniel send``, a
...
_STRICT_ENV = "ATHANIEL_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "ATHANIEL_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "ATHANIEL_MEDIA_TRUST_RECENT_FILES"
