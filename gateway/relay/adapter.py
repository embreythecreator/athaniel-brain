...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (Athaniel-config directed, relay-namespaced):
    ...
    def _slack_unfurl_hints(self, platform: Optional[str]) -> Optional[Dict[str, bool]]:
        ...
        for knob in ("unfurl_links", "unfurl_media"):
            ...
            if val is None:
                continue
            # Railway / `athaniel config set` write YAML strings ("true"/"false").
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a Athaniel prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a Athaniel prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a Athaniel prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack Athaniel already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # Athaniel suppresses this synthetic DM thread anchor; drop it here for the
