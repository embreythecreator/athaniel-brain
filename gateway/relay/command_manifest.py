...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Athaniel session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Athaniel session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Athaniel agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Athaniel Brain to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Athaniel gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Athaniel session in it",
