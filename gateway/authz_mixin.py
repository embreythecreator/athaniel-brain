...
(``~/.athaniel/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke Athaniel. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        # (athaniel gateway pairing approve / the authenticated dashboard) — an
        ...
        # (``load_athaniel_dotenv(override=True)`` in
