...
def _room_grant_token(request: "web.Request") -> str:
    ...
    if not separator or scheme.lower() != "athanielroom":
        return ""
    return token.strip()
...
async def _handle_room_member_invitation(
    ...
    *,
    ...
    return web.json_response(
        {
            "object": "athaniel.room_member.invitation",
            "grant": token,
            "target_profile": profile,
            "catalog": catalog,
...
async def _handle_room_member_capabilities(
    ...
    *,
    ...
    return web.json_response(
        {
            "object": "athaniel.room_member.capabilities",
...
async def _handle_room_member_grant_refresh(
    ...
    *,
    ...
    return web.json_response(
        {
            "object": "athaniel.room_member.grant",
            "grant": token,
...
async def _handle_room_member_grant_revoke(
    ...
    *,
    ...
    return web.json_response(
        {
            "object": "athaniel.room_member.grant.revocation",
            "revoked": True,
        }
    )
