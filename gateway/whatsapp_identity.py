...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ATHANIEL_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_athaniel_dir("platforms/whatsapp/session", "whatsapp/session")
