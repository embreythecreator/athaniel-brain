...
class GatewayStreamConsumer:
    ...
    async def _send_commentary(self, text: str) -> bool:
        ...
        try:
            ...
            # multiple tool calls. See: https://github.com/embreythecreator/athaniel-brain/issues/10454
            if result.success:
    ...
    def _adapter_prefers_fresh_final(self, text: str) -> bool:
        ...
        currently renders richer markdown than Athaniel' MarkdownV2 edit path.
