...
# Set by ``athaniel gateway run --external-supervisor``. Unlike systemd's
...
EXTERNAL_GATEWAY_SUPERVISOR_ENV = "ATHANIEL_GATEWAY_EXTERNAL_SUPERVISOR"
...
def is_gateway_supervisor_process(
    ...
    if env.get("INVOCATION_ID"):
        return True
    if env.get("ATHANIEL_S6_SUPERVISED_CHILD"):
        return True
