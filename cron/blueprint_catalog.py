...
renders natively:
  ...
  * Docs catalog          -> a copy-paste command + a ``athaniel://`` deep-link
...
def blueprint_deeplink(blueprint: AutomationBlueprint, values: Optional[Dict[str, Any]] = None) -> str:
    """Build the ``athaniel://blueprint/<key>?slot=val`` deep-link URL."""
    ...
    return f"athaniel://blueprint/{quote(blueprint.key)}{qs}"
