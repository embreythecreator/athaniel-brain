...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``athaniel logs``.
    ...
    if (
        ...
        # Athaniel only initiates compaction in "athaniel" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Athaniel preflight compression for codex app-server "
                "(mode=%s); Athaniel will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Athaniel (via _emit_status), so it always
