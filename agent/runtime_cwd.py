...
_SESSION_CWD: ContextVar = ContextVar("ATHANIEL_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Athaniel
    # source tree itself, which is a legitimate workspace when the user is
    # developing Athaniel (per-surface policy for fallback-picked directories
