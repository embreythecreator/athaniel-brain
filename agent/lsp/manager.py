...
class LSPService:
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``athaniel_cli.config`` settings.
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        timeout cost — until the service is restarted (``athaniel lsp
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``athaniel lsp status``)
    # ------------------------------------------------------------------
