...
# ``data:`` field before Athaniel receives a completion chunk.  Keeping this
...
# See: https://github.com/embreythecreator/athaniel-brain/issues/69078
...
#
# See: https://github.com/embreythecreator/athaniel-brain/issues/27344
...
# case: a stream dies mid-response and Athaniel persists a content-less
...
# Request parameters that Athaniel sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # athaniel_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from athaniel_cli.plugins import get_plugin_error_classification
