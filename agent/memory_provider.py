...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `athaniel backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - athaniel_home (str): The active ATHANIEL_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.athaniel``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "athaniel").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'athaniel memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], athaniel_home: str) -> None:
        ...
        Called by 'athaniel memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``athaniel_home`` is the active ATHANIEL_HOME directory path.
    ...
    def backup_paths(self) -> List[str]:
        """Return extra on-disk paths this provider stores OUTSIDE ATHANIEL_HOME.

        ``athaniel backup`` only walks ATHANIEL_HOME, so any provider state kept
        ...
        of the archive, and ``athaniel import`` restores them to their original
