...
row taxonomy is inferred from the atlas shape so Athaniel can render both legacy
...
# rows (1536x1872), while older Athaniel/petdex sheets used 9 columns x 8 rows
...
class PetState(str, Enum):
    ...
    These are Athaniel' activity state names. They are not always identical to the
...
# Legacy Athaniel/petdex row order (top -> bottom) used by the older 8-row,
...
# Canonical Athaniel activity names -> accepted row-name aliases in descending
