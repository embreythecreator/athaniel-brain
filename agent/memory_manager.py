...
class MemoryManager:
    ...
    def add_provider(self, provider: MemoryProvider) -> None:
        ...
        _core_tool_names = set(_ATHANIEL_CORE_TOOLS)
    ...
    def _strip_skill_scaffolding(text: str) -> Optional[str]:
        ...
        When a user invokes a /skill or /bundle, Athaniel expands the turn into
    ...
    def _prefetch_provider(
        ...
        # Propagate the caller's contextvars (profile ATHANIEL_HOME override)
    ...
    def _submit_background(self, fn, *, kind: str = "write") -> None:
        ...
        dashboard, cron) is a ContextVar-scoped ATHANIEL_HOME override, and
    ...
    def initialize_all(self, session_id: str, **kwargs) -> None:
        ...
        Automatically injects ``athaniel_home`` into *kwargs* so that every
        provider can resolve profile-scoped storage paths without importing
        ``get_athaniel_home()`` themselves.
        """
        if "athaniel_home" not in kwargs:
            from athaniel_constants import get_athaniel_home
            kwargs["athaniel_home"] = str(get_athaniel_home())
        for provider in self._providers:
            try:
