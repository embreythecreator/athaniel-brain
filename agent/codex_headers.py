...
def codex_cloudflare_headers(
    ...
    the official endpoint always send Athaniel' originator and version. Custom
    ...
    """
    headers = {
        "User-Agent": "codex_cli_rs/0.0.0 (Athaniel Brain)",
    ...
    if is_official_codex_base_url(base_url):
        ...
        headers.update({
            "User-Agent": f"AthanielAgent/{__version__}",
            "originator": "athaniel-brain",
        })
