...
(3 SDK retries x 3 Athaniel retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_athaniel_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".athaniel")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Athaniel, ...) behind one endpoint.  A 429 can mean either:
