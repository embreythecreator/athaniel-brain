"""Core NeMo Relay adapter for Athaniel tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Athaniel tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Athaniel Relay tool execution cannot run on an active event-loop thread"
    )
