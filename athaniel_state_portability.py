    ...
    def import_sessions(self, sessions: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for index, raw in enumerate(sessions):
            ...
            try:
                ...
                clean_session["fork_message_id"] = self._import_text_or_none(
                    clean_session.get("fork_message_id"), "fork_message_id"
                )
            ...
            for item in normalized:
                ...
                conn.execute(
                    """INSERT INTO sessions (
                           ...
                           system_prompt_hash,
                           parent_session_id, fork_message_id, started_at, ended_at, end_reason,
                       ...
                       VALUES (
                           ...
                           NULL, :system_prompt_hash, NULL, :fork_message_id, :started_at, :ended_at,
                       ...
                       )""",
                    {
                        ...
                        "fork_message_id": raw.get("fork_message_id"),
