# Política de Seguridad de Athaniel Brain

Este documento describe el modelo de confianza de Athaniel Brain, identifica el
...
Reporta de forma privada a través de [GitHub Security Advisories](https://github.com/embreythecreator/athaniel-brain/security/advisories/new)
o **security@embreythecreator.com**. No abras issues públicos para
vulnerabilidades de seguridad. **Athaniel Brain no opera un programa de
...
- Detalles del entorno (`athaniel --version`, SHA del commit, SO, versión de Python).
...
Athaniel Brain es un agente personal de un solo inquilino. Su postura es
...
- **Proceso del agente.** El intérprete Python que ejecuta Athaniel Brain,
...
- **Envolvente de confianza.** El conjunto de recursos a los que un operador ha otorgado
  implícitamente acceso a Athaniel Brain al ejecutarlo — típicamente, todo lo que
  la propia cuenta de usuario del operador puede alcanzar en el host.
- **Postura.** Una declaración explícita en la documentación o código de Athaniel Brain
...
Athaniel Brain admite dos posturas de aislamiento a nivel de SO. Abordan
...
Athaniel Brain admite esto de dos maneras:

- **La propia imagen Docker de Athaniel Brain y la configuración de Compose.** Más
...
Bajo una envoltura de proceso completo, las heurísticas en proceso de Athaniel Brain
...
Athaniel Brain filtra el entorno que pasa a sus componentes en proceso de
...
Un plugin malicioso o con errores no es una vulnerabilidad en Athaniel Brain
en sí mismo. Los errores en la ruta de instalación o descubrimiento de plugins de Athaniel Brain
...
4. **Dentro del conjunto autorizado, todos los llamadores tienen la misma confianza.**
   Athaniel Brain no modela capacidades por llamador dentro de un único adaptador.
...
- Violaciones de la documentación del modelo de confianza: código que se comporta
  contrariamente a lo que esta política, la propia documentación de Athaniel Brain o
  las expectativas razonables del operador predecirían — incluyendo casos donde
  Athaniel Brain ha documentado una postura sobre cómo su salida debe ser
...
- **Configuraciones documentadas de emergencia.** Compensaciones seleccionadas por el operador
  ...
  la seguridad de athaniel-home, y similares. Los informes contra esas
...
- **Habilidades y plugins contribuidos por la comunidad.** Las habilidades de terceros
  ...
  están en la superficie de revisión del operador, no en la superficie de confianza de Athaniel Brain
  (§2.4, §2.5). Una habilidad o plugin que haga algo
  malicioso es el modo de falla esperado de uno que no fue
  revisado, no una vulnerabilidad en Athaniel Brain. Los errores en la ruta de
  instalación de habilidades o plugins de Athaniel Brain que impidan al
...
- Athaniel Brain incluye guardias de cadena de suministro para lanzamientos de servidores
