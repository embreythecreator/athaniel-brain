...
_ATHANIEL_CORE_TOOLS = [
    ...
    "text_to_speech",
    # Planning & memory
    "todo", "memory", "save_plan", "convene_debate",
    ...
    # spawned as a kanban worker (ATHANIEL_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "or XAI_API_KEY). Off by default; enable in `athaniel tools` → "
            "X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    ...
    "video_gen": {
        "description": (
            ...
            "``athaniel tools`` → Video Generation."
        ),
    ...
    "plan": {
        ...
        "tools": ["save_plan", "convene_debate"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (ATHANIEL_KANBAN_TASK env "
    ...
    # Coding posture (base Athaniel — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    "coding": {
        ...
        # non-configurable-toolset recovery loop in athaniel_cli/tools_config.py).
        "posture": True,
    },
    
    # ==========================================================================
    # Full Athaniel toolsets (CLI + messaging platforms)
    #
    ...
    # the `athaniel send` CLI), not by the model deciding to send on its own.
    # ==========================================================================
    ...
    "athaniel-cli": {
        ...
        "tools": _ATHANIEL_CORE_TOOLS,
        "includes": []
    },

    "athaniel-cron": {
        # Mirrors athaniel-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `athaniel tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as athaniel-cli; gated by `athaniel tools`",
        "tools": _ATHANIEL_CORE_TOOLS,
        "includes": []
    },
    ...
    "athaniel-bluebubbles": {
        "description": "BlueBubbles iMessage bot toolset - Apple iMessage via local BlueBubbles server",
        "tools": _ATHANIEL_CORE_TOOLS,
        "includes": []
    },

    "athaniel-homeassistant": {
    ...
    "athaniel-email": {
        "description": "Email bot toolset - interact with Athaniel via email (IMAP/SMTP)",
        "tools": _ATHANIEL_CORE_TOOLS,
        "includes": []
    },
    ...
    "athaniel-sms": {
        "description": "SMS bot toolset - interact with Athaniel via SMS (Twilio)",
        "tools": _ATHANIEL_CORE_TOOLS,
        "includes": []
    },
    ...
    "athaniel-webhook": {
        ...
        "tools": _ATHANIEL_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
    ...
    "athaniel-gateway": {
        ...
        "tools": [],
        "includes": ["athaniel-telegram", "athaniel-discord", "athaniel-whatsapp", "athaniel-slack", "athaniel-signal", "athaniel-bluebubbles", "athaniel-homeassistant", "athaniel-email", "athaniel-sms", "athaniel-mattermost", "athaniel-matrix", "athaniel-dingtalk", "athaniel-feishu", "athaniel-wecom", "athaniel-wecom-callback", "athaniel-weixin", "athaniel-qqbot", "athaniel-webhook", "athaniel-yuanbao"]
    }
}
...
def bundle_non_core_tools(toolset_name: str) -> Set[str]:
    """Return a ``athaniel-*`` bundle's platform-specific tools, excluding core.

    Platform bundles are defined as ``_ATHANIEL_CORE_TOOLS + [platform extras]``.
    ...
    Bundle nesting is one level deep in practice (only ``athaniel-gateway``
...
def resolve_toolset(name: str, visited: Set[str] = None, *, include_registry: bool = True) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (athaniel-<name>).
        # Gives them _ATHANIEL_CORE_TOOLS plus any tools the plugin registered
        ...
        if include_registry and name.startswith("athaniel-"):
            platform_name = name[len("athaniel-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_ATHANIEL_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
